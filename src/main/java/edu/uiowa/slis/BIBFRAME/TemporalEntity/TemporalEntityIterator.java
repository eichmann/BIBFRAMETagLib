...
public class TemporalEntityIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TemporalEntityIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TemporalEntityIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.w3.org/TR/owl-time/TemporalEntity> . "+
