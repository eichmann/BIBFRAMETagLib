...
public class TemporalEntityIdentifiedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TemporalEntityIdentifiedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TemporalEntityIdentifiedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TemporalEntityIdentifiedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TemporalEntityIdentifiedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TemporalEntityIdentifiedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TemporalEntityIdentifiedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TemporalEntityIdentifiedBy doEndTag", e);
			throw new JspTagException("Exception raised in TemporalEntityIdentifiedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TemporalEntityIdentifiedByIterator");
