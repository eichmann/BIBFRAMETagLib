...
public class TemporalEntityAgentInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TemporalEntityAgentInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(TemporalEntityAgentInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTemporalEntityAgentInverseIterator.getType());
		} catch (Exception e) {
