...
public class TemporalEntityIsPartOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TemporalEntityIsPartOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TemporalEntityIsPartOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TemporalEntityIsPartOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TemporalEntityIsPartOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TemporalEntityIsPartOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TemporalEntityIsPartOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TemporalEntityIsPartOf doEndTag", e);
			throw new JspTagException("Exception raised in TemporalEntityIsPartOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TemporalEntityIsPartOfIterator");
