...
public class ResourceTerm_statusIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceTerm_statusIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceTerm_statusIterator.class);
