...
public class ResourceAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ResourceAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ResourceAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ResourceAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in ResourceAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ResourceAccompaniedByIterator");
