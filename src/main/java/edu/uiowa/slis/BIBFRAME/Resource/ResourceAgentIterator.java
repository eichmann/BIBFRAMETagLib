...
public class ResourceAgentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceAgentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceAgentIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ResourceAgentIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceAgentIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ResourceAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ResourceAgent doEndTag", e);
			throw new JspTagException("Exception raised in ResourceAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ResourceAgentIterator");
