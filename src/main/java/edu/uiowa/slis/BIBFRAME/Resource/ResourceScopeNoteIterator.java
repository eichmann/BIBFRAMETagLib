...
public class ResourceScopeNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceScopeNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceScopeNoteIterator.class);
