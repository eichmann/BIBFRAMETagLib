...
public class ResourceIdentifiedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceIdentifiedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceIdentifiedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ResourceIdentifiedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceIdentifiedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ResourceIdentifiedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceIdentifiedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ResourceIdentifiedBy doEndTag", e);
			throw new JspTagException("Exception raised in ResourceIdentifiedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ResourceIdentifiedByIterator");
