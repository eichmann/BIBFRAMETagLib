...
public class ResourceAgentInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceAgentInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceAgentInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ResourceAgentInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceAgentInverseIterator doStartTag");
		}
