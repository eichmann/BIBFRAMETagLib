...
public class ResourceIsSubjectOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceIsSubjectOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceIsSubjectOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ResourceIsSubjectOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceIsSubjectOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ResourceIsSubjectOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceIsSubjectOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ResourceIsSubjectOf doEndTag", e);
			throw new JspTagException("Exception raised in ResourceIsSubjectOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ResourceIsSubjectOfIterator");
