...
public class ResourceDefinitionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceDefinitionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceDefinitionIterator.class);
