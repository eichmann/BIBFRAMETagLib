...
public class Resource extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectRelationIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectRelationIterator)this.getParent()).getRelation();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Agent.AgentRelationIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Agent.AgentRelationIterator)this.getParent()).getRelation();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Person.PersonRelationIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Person.PersonRelationIterator)this.getParent()).getRelation();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.IntegratingResource.IntegratingResourceAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.IntegratingResource.IntegratingResourceAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Collection.CollectionAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Collection.CollectionAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.MovingImage.MovingImageAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.MovingImage.MovingImageAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniedByIterator)this.getParent()).getAccompaniedBy();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Audio.AudioPrecedesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Audio.AudioPrecedesIterator)this.getParent()).getPrecedes();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityPrecedesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityPrecedesIterator)this.getParent()).getPrecedes();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicPrecedesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicPrecedesIterator)this.getParent()).getPrecedes();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.RWO.RWOAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.RWO.RWOAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Event.EventAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Event.EventAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Meeting.MeetingAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Meeting.MeetingAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Person.PersonAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Person.PersonAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Audio.AudioAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Audio.AudioAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicAccompaniesIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicAccompaniesIterator)this.getParent()).getAccompanies();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Annotation.AnnotationAnnotatedByIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Annotation.AnnotationAnnotatedByIterator)this.getParent()).getAnnotatedBy();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityFollowsIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityFollowsIterator)this.getParent()).getFollows();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Collection.CollectionIsSubjectOfIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Collection.CollectionIsSubjectOfIterator)this.getParent()).getIsSubjectOf();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.List.ListFirstIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.List.ListFirstIterator)this.getParent()).getFirst();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Item.ItemIsPartOfIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Item.ItemIsPartOfIterator)this.getParent()).getIsPartOf();
			}
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityRelationInverseIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityRelationInverseIterator)this.getParent()).getRelationInverse();
			}
			...
			edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectRelationIterator theThreeDimensionalObjectRelationIterator = (edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectRelationIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectRelationIterator.class);

			if (subjectURI == null && theThreeDimensionalObjectRelationIterator != null) {
				subjectURI = theThreeDimensionalObjectRelationIterator.getRelation();
			}
			...
			edu.uiowa.slis.BIBFRAME.Agent.AgentRelationIterator theAgentRelationIterator = (edu.uiowa.slis.BIBFRAME.Agent.AgentRelationIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Agent.AgentRelationIterator.class);

			if (subjectURI == null && theAgentRelationIterator != null) {
				subjectURI = theAgentRelationIterator.getRelation();
			}

			edu.uiowa.slis.BIBFRAME.Person.PersonRelationIterator thePersonRelationIterator = (edu.uiowa.slis.BIBFRAME.Person.PersonRelationIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Person.PersonRelationIterator.class);

			if (subjectURI == null && thePersonRelationIterator != null) {
				subjectURI = thePersonRelationIterator.getRelation();
			}
			...
			edu.uiowa.slis.BIBFRAME.IntegratingResource.IntegratingResourceAccompaniedByIterator theIntegratingResourceAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.IntegratingResource.IntegratingResourceAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.IntegratingResource.IntegratingResourceAccompaniedByIterator.class);

			if (subjectURI == null && theIntegratingResourceAccompaniedByIterator != null) {
				subjectURI = theIntegratingResourceAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniedByIterator theAgentAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniedByIterator.class);

			if (subjectURI == null && theAgentAccompaniedByIterator != null) {
				subjectURI = theAgentAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniedByIterator theOrganizationAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniedByIterator.class);

			if (subjectURI == null && theOrganizationAccompaniedByIterator != null) {
				subjectURI = theOrganizationAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniedByIterator theCartographyAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniedByIterator.class);

			if (subjectURI == null && theCartographyAccompaniedByIterator != null) {
				subjectURI = theCartographyAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.Collection.CollectionAccompaniedByIterator theCollectionAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.Collection.CollectionAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Collection.CollectionAccompaniedByIterator.class);

			if (subjectURI == null && theCollectionAccompaniedByIterator != null) {
				subjectURI = theCollectionAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniedByIterator theLocationAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniedByIterator.class);

			if (subjectURI == null && theLocationAccompaniedByIterator != null) {
				subjectURI = theLocationAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniedByIterator theDatasetAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniedByIterator.class);

			if (subjectURI == null && theDatasetAccompaniedByIterator != null) {
				subjectURI = theDatasetAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.MovingImage.MovingImageAccompaniedByIterator theMovingImageAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.MovingImage.MovingImageAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.MovingImage.MovingImageAccompaniedByIterator.class);

			if (subjectURI == null && theMovingImageAccompaniedByIterator != null) {
				subjectURI = theMovingImageAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniedByIterator theMultimediaAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniedByIterator.class);

			if (subjectURI == null && theMultimediaAccompaniedByIterator != null) {
				subjectURI = theMultimediaAccompaniedByIterator.getAccompaniedBy();
			}

			edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniedByIterator theStillImageAccompaniedByIterator = (edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniedByIterator.class);

			if (subjectURI == null && theStillImageAccompaniedByIterator != null) {
				subjectURI = theStillImageAccompaniedByIterator.getAccompaniedBy();
			}
			...
			edu.uiowa.slis.BIBFRAME.Audio.AudioPrecedesIterator theAudioPrecedesIterator = (edu.uiowa.slis.BIBFRAME.Audio.AudioPrecedesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Audio.AudioPrecedesIterator.class);

			if (subjectURI == null && theAudioPrecedesIterator != null) {
				subjectURI = theAudioPrecedesIterator.getPrecedes();
			}

			edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityPrecedesIterator theTemporalEntityPrecedesIterator = (edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityPrecedesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityPrecedesIterator.class);

			if (subjectURI == null && theTemporalEntityPrecedesIterator != null) {
				subjectURI = theTemporalEntityPrecedesIterator.getPrecedes();
			}

			edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicPrecedesIterator theNotatedMusicPrecedesIterator = (edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicPrecedesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicPrecedesIterator.class);

			if (subjectURI == null && theNotatedMusicPrecedesIterator != null) {
				subjectURI = theNotatedMusicPrecedesIterator.getPrecedes();
			}
			...
			edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniesIterator theAgentAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Agent.AgentAccompaniesIterator.class);

			if (subjectURI == null && theAgentAccompaniesIterator != null) {
				subjectURI = theAgentAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniesIterator theDatasetAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Dataset.DatasetAccompaniesIterator.class);

			if (subjectURI == null && theDatasetAccompaniesIterator != null) {
				subjectURI = theDatasetAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniesIterator theMultimediaAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Multimedia.MultimediaAccompaniesIterator.class);

			if (subjectURI == null && theMultimediaAccompaniesIterator != null) {
				subjectURI = theMultimediaAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniesIterator theOrganizationAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Organization.OrganizationAccompaniesIterator.class);

			if (subjectURI == null && theOrganizationAccompaniesIterator != null) {
				subjectURI = theOrganizationAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniesIterator theCartographyAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Cartography.CartographyAccompaniesIterator.class);

			if (subjectURI == null && theCartographyAccompaniesIterator != null) {
				subjectURI = theCartographyAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniesIterator theStillImageAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.StillImage.StillImageAccompaniesIterator.class);

			if (subjectURI == null && theStillImageAccompaniesIterator != null) {
				subjectURI = theStillImageAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.RWO.RWOAccompaniesIterator theRWOAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.RWO.RWOAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.RWO.RWOAccompaniesIterator.class);

			if (subjectURI == null && theRWOAccompaniesIterator != null) {
				subjectURI = theRWOAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectAccompaniesIterator theThreeDimensionalObjectAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.ThreeDimensionalObject.ThreeDimensionalObjectAccompaniesIterator.class);

			if (subjectURI == null && theThreeDimensionalObjectAccompaniesIterator != null) {
				subjectURI = theThreeDimensionalObjectAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Event.EventAccompaniesIterator theEventAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Event.EventAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Event.EventAccompaniesIterator.class);

			if (subjectURI == null && theEventAccompaniesIterator != null) {
				subjectURI = theEventAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Meeting.MeetingAccompaniesIterator theMeetingAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Meeting.MeetingAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Meeting.MeetingAccompaniesIterator.class);

			if (subjectURI == null && theMeetingAccompaniesIterator != null) {
				subjectURI = theMeetingAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniesIterator theLocationAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Location.LocationAccompaniesIterator.class);

			if (subjectURI == null && theLocationAccompaniesIterator != null) {
				subjectURI = theLocationAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Person.PersonAccompaniesIterator thePersonAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Person.PersonAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Person.PersonAccompaniesIterator.class);

			if (subjectURI == null && thePersonAccompaniesIterator != null) {
				subjectURI = thePersonAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Audio.AudioAccompaniesIterator theAudioAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.Audio.AudioAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Audio.AudioAccompaniesIterator.class);

			if (subjectURI == null && theAudioAccompaniesIterator != null) {
				subjectURI = theAudioAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicAccompaniesIterator theNotatedMusicAccompaniesIterator = (edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicAccompaniesIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.NotatedMusic.NotatedMusicAccompaniesIterator.class);

			if (subjectURI == null && theNotatedMusicAccompaniesIterator != null) {
				subjectURI = theNotatedMusicAccompaniesIterator.getAccompanies();
			}

			edu.uiowa.slis.BIBFRAME.Annotation.AnnotationAnnotatedByIterator theAnnotationAnnotatedByIterator = (edu.uiowa.slis.BIBFRAME.Annotation.AnnotationAnnotatedByIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Annotation.AnnotationAnnotatedByIterator.class);

			if (subjectURI == null && theAnnotationAnnotatedByIterator != null) {
				subjectURI = theAnnotationAnnotatedByIterator.getAnnotatedBy();
			}
			...
			edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityFollowsIterator theTemporalEntityFollowsIterator = (edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityFollowsIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.TemporalEntity.TemporalEntityFollowsIterator.class);

			if (subjectURI == null && theTemporalEntityFollowsIterator != null) {
				subjectURI = theTemporalEntityFollowsIterator.getFollows();
			}
			...
			edu.uiowa.slis.BIBFRAME.Collection.CollectionIsSubjectOfIterator theCollectionIsSubjectOfIterator = (edu.uiowa.slis.BIBFRAME.Collection.CollectionIsSubjectOfIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Collection.CollectionIsSubjectOfIterator.class);

			if (subjectURI == null && theCollectionIsSubjectOfIterator != null) {
				subjectURI = theCollectionIsSubjectOfIterator.getIsSubjectOf();
			}
			...
			edu.uiowa.slis.BIBFRAME.List.ListFirstIterator theListFirstIterator = (edu.uiowa.slis.BIBFRAME.List.ListFirstIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.List.ListFirstIterator.class);
			...
			edu.uiowa.slis.BIBFRAME.Item.ItemIsPartOfIterator theItemIsPartOfIterator = (edu.uiowa.slis.BIBFRAME.Item.ItemIsPartOfIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Item.ItemIsPartOfIterator.class);

			if (subjectURI == null && theItemIsPartOfIterator != null) {
				subjectURI = theItemIsPartOfIterator.getIsPartOf();
			}
