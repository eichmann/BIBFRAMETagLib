...
public class ResourceExampleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceExampleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceExampleIterator.class);
