...
public class ResourceHasSourceStatusType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceHasSourceStatusType currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceHasSourceStatusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResourceHasSourceStatusIterator.getType());
		} catch (Exception e) {
