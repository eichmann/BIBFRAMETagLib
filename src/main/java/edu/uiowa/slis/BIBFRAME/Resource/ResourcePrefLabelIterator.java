...
public class ResourcePrefLabelIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourcePrefLabelIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourcePrefLabelIterator.class);
