...
public class ResourceNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceNameIterator.class);
