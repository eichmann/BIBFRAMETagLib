...
public class ResourceValueIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?s } ");
			if(rs.hasNext()) {
