...
public class ResourceIsDefinedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceIsDefinedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceIsDefinedByIterator.class);
