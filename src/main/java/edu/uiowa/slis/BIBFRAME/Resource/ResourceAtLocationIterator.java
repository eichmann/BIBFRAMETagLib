...
public class ResourceAtLocationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceAtLocationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceAtLocationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ResourceAtLocationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceAtLocationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ResourceAtLocationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceAtLocationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ResourceAtLocation doEndTag", e);
			throw new JspTagException("Exception raised in ResourceAtLocation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ResourceAtLocationIterator");
