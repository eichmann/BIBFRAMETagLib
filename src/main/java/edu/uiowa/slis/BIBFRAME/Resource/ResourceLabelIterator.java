...
public class ResourceLabelIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceLabelIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceLabelIterator.class);
