...
public class ResourceDeathDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceDeathDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceDeathDateIterator.class);
