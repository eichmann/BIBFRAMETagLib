...
public class ResourceLanguageIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceLanguageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceLanguageIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ResourceLanguageIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceLanguageIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ResourceLanguageIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceLanguageIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ResourceLanguage doEndTag", e);
			throw new JspTagException("Exception raised in ResourceLanguage doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ResourceLanguageIterator");
