...
public class ResourceEditorialNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceEditorialNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceEditorialNoteIterator.class);
