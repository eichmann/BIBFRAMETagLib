...
public class ResourceRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ResourceRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ResourceRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ResourceRelationInverseIterator doStartTag");
		}
