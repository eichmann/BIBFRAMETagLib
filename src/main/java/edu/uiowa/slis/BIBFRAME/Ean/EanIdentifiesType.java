...
public class EanIdentifiesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EanIdentifiesType currentInstance = null;
	private static final Log log = LogFactory.getLog(EanIdentifiesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEanIdentifiesIterator.getType());
		} catch (Exception e) {
