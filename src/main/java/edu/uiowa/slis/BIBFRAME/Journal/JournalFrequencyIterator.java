...
public class JournalFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalFrequencyIterator.class);
