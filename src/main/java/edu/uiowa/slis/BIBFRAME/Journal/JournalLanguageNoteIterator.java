...
public class JournalLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalLanguageNoteIterator.class);
