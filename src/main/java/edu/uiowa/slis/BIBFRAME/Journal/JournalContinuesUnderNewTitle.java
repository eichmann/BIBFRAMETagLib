...
public class JournalContinuesUnderNewTitle extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalContinuesUnderNewTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalContinuesUnderNewTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalContinuesUnderNewTitleIterator.getContinuesUnderNewTitle());
		} catch (Exception e) {
