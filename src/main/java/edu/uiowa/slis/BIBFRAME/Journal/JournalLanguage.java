...
public class JournalLanguage extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalLanguage currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalLanguage.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalLanguageIterator.getLanguage());
		} catch (Exception e) {
