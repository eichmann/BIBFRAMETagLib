...
public class JournalTranslatesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalTranslatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalTranslatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalTranslatesIterator.getType());
		} catch (Exception e) {
