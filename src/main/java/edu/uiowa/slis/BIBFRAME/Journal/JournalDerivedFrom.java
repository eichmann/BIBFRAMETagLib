...
public class JournalDerivedFrom extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalDerivedFrom currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalDerivedFrom.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalDerivedFromIterator.getDerivedFrom());
		} catch (Exception e) {
