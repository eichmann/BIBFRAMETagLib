...
public class JournalRecordedAtType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalRecordedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalRecordedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalRecordedAtIterator.getType());
		} catch (Exception e) {
