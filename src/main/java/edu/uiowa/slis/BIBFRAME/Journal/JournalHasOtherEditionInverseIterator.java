...
public class JournalHasOtherEditionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalHasOtherEditionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHasOtherEditionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in JournalHasOtherEditionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in JournalHasOtherEditionInverseIterator doStartTag");
		}
