...
public class JournalPrecedesInNarrativeInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static JournalPrecedesInNarrativeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalPrecedesInNarrativeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalPrecedesInNarrativeInverseIterator.getType());
		} catch (Exception e) {
