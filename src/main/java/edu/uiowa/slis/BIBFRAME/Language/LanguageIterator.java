package edu.uiowa.slis.BIBFRAME.Language;
...
public class LanguageIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.loc.gov/mads/rdf/v1#Language> . "+
