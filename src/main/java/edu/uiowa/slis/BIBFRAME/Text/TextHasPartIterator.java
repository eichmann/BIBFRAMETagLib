...
public class TextHasPartIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextHasPartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextHasPartIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextHasPartIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextHasPartIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TextHasPartIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextHasPartIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TextHasPart doEndTag", e);
			throw new JspTagException("Exception raised in TextHasPart doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TextHasPartIterator");
