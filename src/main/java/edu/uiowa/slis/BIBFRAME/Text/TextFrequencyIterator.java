...
public class TextFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextFrequencyIterator.class);
