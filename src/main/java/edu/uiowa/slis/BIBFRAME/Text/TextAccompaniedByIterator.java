...
public class TextAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TextAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TextAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in TextAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TextAccompaniedByIterator");
