...
public class TextContinuedUnderNewTitleByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextContinuedUnderNewTitleByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextContinuedUnderNewTitleByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextContinuedUnderNewTitleByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextContinuedUnderNewTitleByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TextContinuedUnderNewTitleByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextContinuedUnderNewTitleByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TextContinuedUnderNewTitleBy doEndTag", e);
			throw new JspTagException("Exception raised in TextContinuedUnderNewTitleBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TextContinuedUnderNewTitleByIterator");
