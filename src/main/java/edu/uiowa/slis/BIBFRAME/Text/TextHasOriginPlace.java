...
public class TextHasOriginPlace extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextHasOriginPlace currentInstance = null;
	private static final Log log = LogFactory.getLog(TextHasOriginPlace.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTextHasOriginPlaceIterator.getHasOriginPlace());
		} catch (Exception e) {
