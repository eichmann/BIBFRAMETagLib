...
public class TextContinuesUnderNewTitleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextContinuesUnderNewTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextContinuesUnderNewTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextContinuesUnderNewTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextContinuesUnderNewTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TextContinuesUnderNewTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextContinuesUnderNewTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TextContinuesUnderNewTitle doEndTag", e);
			throw new JspTagException("Exception raised in TextContinuesUnderNewTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TextContinuesUnderNewTitleIterator");
