...
public class TextHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextHasOriginalVersionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextHasOriginalVersionIterator doStartTag");
		}
