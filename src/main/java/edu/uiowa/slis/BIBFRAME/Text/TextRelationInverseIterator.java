...
public class TextRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TextRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TextRelation doEndTag", e);
			throw new JspTagException("Exception raised in TextRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TextRelationIterator");
