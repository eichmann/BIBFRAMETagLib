...
public class TextIsLastOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextIsLastOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(TextIsLastOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTextIsLastOfIterator.getType());
		} catch (Exception e) {
