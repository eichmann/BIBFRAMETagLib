...
public class TextHasTitleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextHasTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextHasTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextHasTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextHasTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TextHasTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextHasTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TextHasTitle doEndTag", e);
			throw new JspTagException("Exception raised in TextHasTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TextHasTitleIterator");
