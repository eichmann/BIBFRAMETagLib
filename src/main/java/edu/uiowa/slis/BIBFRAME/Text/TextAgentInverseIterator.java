...
public class TextAgentInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextAgentInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextAgentInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextAgentInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextAgentInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TextAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TextAgent doEndTag", e);
			throw new JspTagException("Exception raised in TextAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TextAgentIterator");
