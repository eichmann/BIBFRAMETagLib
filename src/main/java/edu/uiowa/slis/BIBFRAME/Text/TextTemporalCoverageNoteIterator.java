...
public class TextTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextTemporalCoverageNoteIterator.class);
