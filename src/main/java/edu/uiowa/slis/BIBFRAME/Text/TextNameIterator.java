...
public class TextNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextNameIterator.class);
