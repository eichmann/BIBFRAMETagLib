...
public class TextRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextRelationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextRelationIterator doStartTag");
		}
