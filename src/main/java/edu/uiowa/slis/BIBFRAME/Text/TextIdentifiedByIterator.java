...
public class TextIdentifiedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextIdentifiedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TextIdentifiedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TextIdentifiedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextIdentifiedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TextIdentifiedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TextIdentifiedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TextIdentifiedBy doEndTag", e);
			throw new JspTagException("Exception raised in TextIdentifiedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TextIdentifiedByIterator");
