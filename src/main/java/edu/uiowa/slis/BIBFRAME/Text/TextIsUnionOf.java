...
public class TextIsUnionOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TextIsUnionOf currentInstance = null;
	private static final Log log = LogFactory.getLog(TextIsUnionOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTextIsUnionOfIterator.getIsUnionOf());
		} catch (Exception e) {
