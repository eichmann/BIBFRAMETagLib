...
public class ContainerTitleHasSourceStatus extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContainerTitleHasSourceStatus currentInstance = null;
	private static final Log log = LogFactory.getLog(ContainerTitleHasSourceStatus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContainerTitleHasSourceStatusIterator.getHasSourceStatus());
		} catch (Exception e) {
