...
public class ContainerTitleHasPartType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContainerTitleHasPartType currentInstance = null;
	private static final Log log = LogFactory.getLog(ContainerTitleHasPartType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContainerTitleHasPartIterator.getType());
		} catch (Exception e) {
