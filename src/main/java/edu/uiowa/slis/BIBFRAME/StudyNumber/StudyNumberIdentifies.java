...
public class StudyNumberIdentifies extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StudyNumberIdentifies currentInstance = null;
	private static final Log log = LogFactory.getLog(StudyNumberIdentifies.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudyNumberIdentifiesIterator.getIdentifies());
		} catch (Exception e) {
