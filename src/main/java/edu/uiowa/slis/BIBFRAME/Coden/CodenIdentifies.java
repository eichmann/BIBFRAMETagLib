...
public class CodenIdentifies extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CodenIdentifies currentInstance = null;
	private static final Log log = LogFactory.getLog(CodenIdentifies.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCodenIdentifiesIterator.getIdentifies());
		} catch (Exception e) {
