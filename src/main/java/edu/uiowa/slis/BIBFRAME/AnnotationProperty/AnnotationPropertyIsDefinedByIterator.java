...
public class AnnotationPropertyIsDefinedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AnnotationPropertyIsDefinedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AnnotationPropertyIsDefinedByIterator.class);
