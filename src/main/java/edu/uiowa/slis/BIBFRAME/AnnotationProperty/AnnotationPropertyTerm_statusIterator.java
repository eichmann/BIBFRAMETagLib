...
public class AnnotationPropertyTerm_statusIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AnnotationPropertyTerm_statusIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AnnotationPropertyTerm_statusIterator.class);
