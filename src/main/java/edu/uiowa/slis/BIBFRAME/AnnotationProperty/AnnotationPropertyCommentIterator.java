...
public class AnnotationPropertyCommentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AnnotationPropertyCommentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AnnotationPropertyCommentIterator.class);
