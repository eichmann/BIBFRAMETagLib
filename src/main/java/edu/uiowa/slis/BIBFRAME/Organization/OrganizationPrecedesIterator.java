...
public class OrganizationPrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static OrganizationPrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationPrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in OrganizationPrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OrganizationPrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in OrganizationPrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OrganizationPrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in OrganizationPrecedes doEndTag", e);
			throw new JspTagException("Exception raised in OrganizationPrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to OrganizationPrecedesIterator");
