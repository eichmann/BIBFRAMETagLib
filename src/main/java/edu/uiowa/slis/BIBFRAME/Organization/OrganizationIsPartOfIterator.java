...
public class OrganizationIsPartOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static OrganizationIsPartOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationIsPartOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in OrganizationIsPartOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OrganizationIsPartOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in OrganizationIsPartOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OrganizationIsPartOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in OrganizationIsPartOf doEndTag", e);
			throw new JspTagException("Exception raised in OrganizationIsPartOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to OrganizationIsPartOfIterator");
