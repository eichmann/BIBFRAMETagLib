...
public class OrganizationAgentInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static OrganizationAgentInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationAgentInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationAgentInverseIterator.getType());
		} catch (Exception e) {
