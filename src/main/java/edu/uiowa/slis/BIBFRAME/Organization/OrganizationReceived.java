...
public class OrganizationReceived extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static OrganizationReceived currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationReceived.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationReceivedIterator.getReceived());
		} catch (Exception e) {
