...
public class OrganizationDeathDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static OrganizationDeathDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationDeathDateIterator.class);
