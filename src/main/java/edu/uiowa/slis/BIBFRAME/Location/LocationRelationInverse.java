...
public class LocationRelationInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationRelationInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationRelationInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationRelationInverseIterator.getRelationInverse());
		} catch (Exception e) {
