...
public class LocationHasAnnotationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationHasAnnotationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHasAnnotationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in LocationHasAnnotationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationHasAnnotationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in LocationHasAnnotationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationHasAnnotationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LocationHasAnnotation doEndTag", e);
			throw new JspTagException("Exception raised in LocationHasAnnotation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to LocationHasAnnotationIterator");
