...
public class Location extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Resource.ResourceAtLocationIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Resource.ResourceAtLocationIterator)this.getParent()).getAtLocation();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Thing.ThingAtLocationIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Thing.ThingAtLocationIterator)this.getParent()).getAtLocation();
			}

			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.Provision.ProvisionAtLocationIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.Provision.ProvisionAtLocationIterator)this.getParent()).getAtLocation();
			}
			...
			edu.uiowa.slis.BIBFRAME.Resource.ResourceAtLocationIterator theResourceAtLocationIterator = (edu.uiowa.slis.BIBFRAME.Resource.ResourceAtLocationIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Resource.ResourceAtLocationIterator.class);

			if (subjectURI == null && theResourceAtLocationIterator != null) {
				subjectURI = theResourceAtLocationIterator.getAtLocation();
			}

			edu.uiowa.slis.BIBFRAME.Thing.ThingAtLocationIterator theThingAtLocationIterator = (edu.uiowa.slis.BIBFRAME.Thing.ThingAtLocationIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Thing.ThingAtLocationIterator.class);

			if (subjectURI == null && theThingAtLocationIterator != null) {
				subjectURI = theThingAtLocationIterator.getAtLocation();
			}

			edu.uiowa.slis.BIBFRAME.Provision.ProvisionAtLocationIterator theProvisionAtLocationIterator = (edu.uiowa.slis.BIBFRAME.Provision.ProvisionAtLocationIterator) findAncestorWithClass(this, edu.uiowa.slis.BIBFRAME.Provision.ProvisionAtLocationIterator.class);

			if (subjectURI == null && theProvisionAtLocationIterator != null) {
				subjectURI = theProvisionAtLocationIterator.getAtLocation();
			}
