...
public class LocationHasPart extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationHasPart currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHasPart.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationHasPartIterator.getHasPart());
		} catch (Exception e) {
