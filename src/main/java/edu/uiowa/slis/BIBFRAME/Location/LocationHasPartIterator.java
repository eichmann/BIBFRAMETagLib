...
public class LocationHasPartIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationHasPartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHasPartIterator.class);
...
//					continue;
			...
			log.error("Exception raised in LocationHasPartIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationHasPartIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in LocationHasPartIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationHasPartIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LocationHasPart doEndTag", e);
			throw new JspTagException("Exception raised in LocationHasPart doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to LocationHasPartIterator");
