...
public class LocationSubjectIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationSubjectIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationSubjectIterator.class);
...
//					continue;
			...
			log.error("Exception raised in LocationSubjectIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationSubjectIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in LocationSubjectIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationSubjectIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LocationSubject doEndTag", e);
			throw new JspTagException("Exception raised in LocationSubject doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to LocationSubjectIterator");
