...
public class LocationLanguageIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationLanguageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationLanguageIterator.class);
...
//					continue;
			...
			log.error("Exception raised in LocationLanguageIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationLanguageIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in LocationLanguageIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationLanguageIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LocationLanguage doEndTag", e);
			throw new JspTagException("Exception raised in LocationLanguage doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to LocationLanguageIterator");
