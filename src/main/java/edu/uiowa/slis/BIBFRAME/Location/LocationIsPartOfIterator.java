...
public class LocationIsPartOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationIsPartOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationIsPartOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in LocationIsPartOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationIsPartOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in LocationIsPartOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationIsPartOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LocationIsPartOf doEndTag", e);
			throw new JspTagException("Exception raised in LocationIsPartOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to LocationIsPartOfIterator");
