...
public class LocationFollowsType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationFollowsType currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationFollowsType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationFollowsIterator.getType());
		} catch (Exception e) {
