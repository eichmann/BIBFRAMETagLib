...
public class LocationBirthDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationBirthDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationBirthDateIterator.class);
