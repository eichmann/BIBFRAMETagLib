...
public class LocationAccompaniedByType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationAccompaniedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationAccompaniedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationAccompaniedByIterator.getType());
		} catch (Exception e) {
