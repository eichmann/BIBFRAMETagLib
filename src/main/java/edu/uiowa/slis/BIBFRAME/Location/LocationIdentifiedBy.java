...
public class LocationIdentifiedBy extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationIdentifiedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationIdentifiedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationIdentifiedByIterator.getIdentifiedBy());
		} catch (Exception e) {
