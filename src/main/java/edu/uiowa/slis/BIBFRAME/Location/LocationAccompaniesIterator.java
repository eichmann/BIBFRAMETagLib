...
public class LocationAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationAccompaniesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationAccompaniesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in LocationAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in LocationAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LocationAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in LocationAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to LocationAccompaniesIterator");
