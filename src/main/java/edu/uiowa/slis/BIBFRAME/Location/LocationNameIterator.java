...
public class LocationNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameIterator.class);
