...
public class LocationPrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LocationPrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationPrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in LocationPrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationPrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in LocationPrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LocationPrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LocationPrecedes doEndTag", e);
			throw new JspTagException("Exception raised in LocationPrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to LocationPrecedesIterator");
