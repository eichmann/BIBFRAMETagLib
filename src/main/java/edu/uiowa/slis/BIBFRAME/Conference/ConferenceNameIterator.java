...
public class ConferenceNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ConferenceNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameIterator.class);
