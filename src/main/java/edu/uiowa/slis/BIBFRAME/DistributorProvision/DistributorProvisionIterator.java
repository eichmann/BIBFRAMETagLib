...
public class DistributorProvisionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DistributorProvisionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DistributorProvisionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/DistributorProvision> . "+
