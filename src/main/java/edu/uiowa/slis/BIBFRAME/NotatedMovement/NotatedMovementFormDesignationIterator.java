...
public class NotatedMovementFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementFormDesignationIterator.class);
