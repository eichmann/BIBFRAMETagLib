...
public class NotatedMovementPrecedesInNarrativeInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementPrecedesInNarrativeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementPrecedesInNarrativeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNotatedMovementPrecedesInNarrativeInverseIterator.getType());
		} catch (Exception e) {
