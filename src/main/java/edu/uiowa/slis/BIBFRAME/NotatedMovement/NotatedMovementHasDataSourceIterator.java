...
public class NotatedMovementHasDataSourceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementHasDataSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementHasDataSourceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NotatedMovementHasDataSourceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMovementHasDataSourceIterator doStartTag");
		}
