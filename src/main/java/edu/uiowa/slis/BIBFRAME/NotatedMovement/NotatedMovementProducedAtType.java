...
public class NotatedMovementProducedAtType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementProducedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementProducedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNotatedMovementProducedAtIterator.getType());
		} catch (Exception e) {
