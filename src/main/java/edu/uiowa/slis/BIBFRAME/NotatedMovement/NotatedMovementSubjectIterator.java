...
public class NotatedMovementSubjectIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementSubjectIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementSubjectIterator.class);
...
//					continue;
			...
			log.error("Exception raised in NotatedMovementSubjectIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMovementSubjectIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in NotatedMovementSubjectIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMovementSubjectIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NotatedMovementSubject doEndTag", e);
			throw new JspTagException("Exception raised in NotatedMovementSubject doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to NotatedMovementSubjectIterator");
