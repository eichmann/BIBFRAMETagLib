...
public class NotatedMovementHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementHasOriginalVersionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NotatedMovementHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMovementHasOriginalVersionIterator doStartTag");
		}
