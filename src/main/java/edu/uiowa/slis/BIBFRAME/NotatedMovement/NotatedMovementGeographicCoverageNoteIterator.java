...
public class NotatedMovementGeographicCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementGeographicCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementGeographicCoverageNoteIterator.class);
