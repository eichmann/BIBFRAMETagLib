...
public class NotatedMovementFollowsInNarrativeIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementFollowsInNarrativeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementFollowsInNarrativeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NotatedMovementFollowsInNarrativeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMovementFollowsInNarrativeIterator doStartTag");
		}
