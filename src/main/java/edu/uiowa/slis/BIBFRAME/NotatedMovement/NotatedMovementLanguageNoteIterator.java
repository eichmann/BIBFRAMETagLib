...
public class NotatedMovementLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementLanguageNoteIterator.class);
