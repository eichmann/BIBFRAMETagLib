...
public class NotatedMovementDerivedFromType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementDerivedFromType currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementDerivedFromType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNotatedMovementDerivedFromIterator.getType());
		} catch (Exception e) {
