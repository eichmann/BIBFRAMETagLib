...
public class NotatedMovementFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementFrequencyIterator.class);
