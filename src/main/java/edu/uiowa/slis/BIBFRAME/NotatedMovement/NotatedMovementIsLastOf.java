...
public class NotatedMovementIsLastOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementIsLastOf currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementIsLastOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNotatedMovementIsLastOfIterator.getIsLastOf());
		} catch (Exception e) {
