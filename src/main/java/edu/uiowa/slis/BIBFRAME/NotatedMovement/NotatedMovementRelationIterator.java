...
public class NotatedMovementRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementRelationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in NotatedMovementRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMovementRelationIterator doStartTag");
		}
