...
public class NotatedMovementSeparatedFromType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementSeparatedFromType currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementSeparatedFromType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNotatedMovementSeparatedFromIterator.getType());
		} catch (Exception e) {
