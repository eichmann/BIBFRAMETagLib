...
public class NotatedMovementHasInstanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMovementHasInstanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMovementHasInstanceIterator.class);
...
//					continue;
			...
			log.error("Exception raised in NotatedMovementHasInstanceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMovementHasInstanceIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in NotatedMovementHasInstanceIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMovementHasInstanceIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NotatedMovementHasInstance doEndTag", e);
			throw new JspTagException("Exception raised in NotatedMovementHasInstance doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to NotatedMovementHasInstanceIterator");
