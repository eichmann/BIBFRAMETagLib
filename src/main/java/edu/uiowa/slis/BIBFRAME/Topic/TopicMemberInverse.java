...
public class TopicMemberInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TopicMemberInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(TopicMemberInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTopicMemberInverseIterator.getMemberInverse());
		} catch (Exception e) {
