...
public class TopicIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TopicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TopicIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/Topic> . "+
