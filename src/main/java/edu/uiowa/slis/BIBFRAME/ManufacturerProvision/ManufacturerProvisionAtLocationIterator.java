...
public class ManufacturerProvisionAtLocationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ManufacturerProvisionAtLocationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManufacturerProvisionAtLocationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ManufacturerProvisionAtLocationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ManufacturerProvisionAtLocationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ManufacturerProvisionAtLocationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ManufacturerProvisionAtLocationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ManufacturerProvisionAtLocation doEndTag", e);
			throw new JspTagException("Exception raised in ManufacturerProvisionAtLocation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ManufacturerProvisionAtLocationIterator");
