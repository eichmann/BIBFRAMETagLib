...
public class ManufacturerProvisionAgentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ManufacturerProvisionAgentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManufacturerProvisionAgentIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ManufacturerProvisionAgentIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ManufacturerProvisionAgentIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ManufacturerProvisionAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ManufacturerProvisionAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ManufacturerProvisionAgent doEndTag", e);
			throw new JspTagException("Exception raised in ManufacturerProvisionAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ManufacturerProvisionAgentIterator");
