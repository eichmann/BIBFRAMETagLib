...
public class SeriesHasDataSourceInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SeriesHasDataSourceInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesHasDataSourceInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesHasDataSourceInverseIterator.getType());
		} catch (Exception e) {
