...
public class SeriesContinuesUnderNewTitleType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SeriesContinuesUnderNewTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesContinuesUnderNewTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesContinuesUnderNewTitleIterator.getType());
		} catch (Exception e) {
