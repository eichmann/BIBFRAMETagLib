...
public class SeriesAbsorbedBy extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SeriesAbsorbedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesAbsorbedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesAbsorbedByIterator.getAbsorbedBy());
		} catch (Exception e) {
