...
public class SeriesSeparatedInto extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SeriesSeparatedInto currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesSeparatedInto.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesSeparatedIntoIterator.getSeparatedInto());
		} catch (Exception e) {
