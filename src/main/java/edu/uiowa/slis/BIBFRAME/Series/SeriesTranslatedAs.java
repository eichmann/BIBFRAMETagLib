...
public class SeriesTranslatedAs extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SeriesTranslatedAs currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesTranslatedAs.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesTranslatedAsIterator.getTranslatedAs());
		} catch (Exception e) {
