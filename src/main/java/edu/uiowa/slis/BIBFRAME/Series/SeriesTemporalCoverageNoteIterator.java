...
public class SeriesTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SeriesTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesTemporalCoverageNoteIterator.class);
