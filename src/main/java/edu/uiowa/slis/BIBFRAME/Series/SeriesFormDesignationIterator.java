...
public class SeriesFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SeriesFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesFormDesignationIterator.class);
