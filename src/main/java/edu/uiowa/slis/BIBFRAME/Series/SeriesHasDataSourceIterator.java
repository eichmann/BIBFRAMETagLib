...
public class SeriesHasDataSourceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SeriesHasDataSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesHasDataSourceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SeriesHasDataSourceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SeriesHasDataSourceIterator doStartTag");
		}
