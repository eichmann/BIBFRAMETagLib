...
public class PublisherProvisionAgentType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PublisherProvisionAgentType currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherProvisionAgentType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherProvisionAgentIterator.getType());
		} catch (Exception e) {
