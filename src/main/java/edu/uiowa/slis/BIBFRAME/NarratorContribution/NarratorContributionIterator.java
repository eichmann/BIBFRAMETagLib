...
public class NarratorContributionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NarratorContributionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NarratorContributionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/NarratorContribution> . "+
			...
			log.error("Exception raised in NarratorContributionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NarratorContributionIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in NarratorContributionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NarratorContributionIterator doAfterBody");
		}
