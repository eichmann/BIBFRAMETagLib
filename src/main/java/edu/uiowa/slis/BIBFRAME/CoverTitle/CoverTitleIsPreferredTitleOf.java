...
public class CoverTitleIsPreferredTitleOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CoverTitleIsPreferredTitleOf currentInstance = null;
	private static final Log log = LogFactory.getLog(CoverTitleIsPreferredTitleOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoverTitleIsPreferredTitleOfIterator.getIsPreferredTitleOf());
		} catch (Exception e) {
