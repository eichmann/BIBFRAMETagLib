...
public class PersonIsSubjectOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PersonIsSubjectOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonIsSubjectOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in PersonIsSubjectOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PersonIsSubjectOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in PersonIsSubjectOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PersonIsSubjectOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PersonIsSubjectOf doEndTag", e);
			throw new JspTagException("Exception raised in PersonIsSubjectOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to PersonIsSubjectOfIterator");
