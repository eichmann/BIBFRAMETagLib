...
public class PersonFollowsType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PersonFollowsType currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonFollowsType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonFollowsIterator.getType());
		} catch (Exception e) {
