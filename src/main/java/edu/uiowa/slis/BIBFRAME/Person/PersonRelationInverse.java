...
public class PersonRelationInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PersonRelationInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonRelationInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonRelationInverseIterator.getRelationInverse());
		} catch (Exception e) {
