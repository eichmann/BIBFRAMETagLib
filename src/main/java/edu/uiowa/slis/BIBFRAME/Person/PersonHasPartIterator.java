...
public class PersonHasPartIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PersonHasPartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHasPartIterator.class);
...
//					continue;
			...
			log.error("Exception raised in PersonHasPartIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PersonHasPartIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in PersonHasPartIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PersonHasPartIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PersonHasPart doEndTag", e);
			throw new JspTagException("Exception raised in PersonHasPart doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to PersonHasPartIterator");
