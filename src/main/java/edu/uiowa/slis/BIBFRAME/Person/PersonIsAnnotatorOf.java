...
public class PersonIsAnnotatorOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PersonIsAnnotatorOf currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonIsAnnotatorOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonIsAnnotatorOfIterator.getIsAnnotatorOf());
		} catch (Exception e) {
