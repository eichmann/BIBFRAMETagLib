...
public class AgentAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AgentAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AgentAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in AgentAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AgentAccompaniedByIterator");
