...
public class AgentAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentAccompaniesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentAccompaniesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AgentAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AgentAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in AgentAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AgentAccompaniesIterator");
