...
public class AgentFollowsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentFollowsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentFollowsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AgentFollowsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentFollowsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AgentFollowsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentFollowsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentFollows doEndTag", e);
			throw new JspTagException("Exception raised in AgentFollows doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AgentFollowsIterator");
