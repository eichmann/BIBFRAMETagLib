...
public class AgentIsSubjectOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentIsSubjectOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentIsSubjectOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AgentIsSubjectOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentIsSubjectOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AgentIsSubjectOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentIsSubjectOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentIsSubjectOf doEndTag", e);
			throw new JspTagException("Exception raised in AgentIsSubjectOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AgentIsSubjectOfIterator");
