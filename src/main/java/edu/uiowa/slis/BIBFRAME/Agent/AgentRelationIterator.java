...
public class AgentRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentRelationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AgentRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentRelationIterator doStartTag");
		}
