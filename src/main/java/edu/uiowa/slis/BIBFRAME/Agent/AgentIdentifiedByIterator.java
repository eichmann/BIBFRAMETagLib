...
public class AgentIdentifiedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentIdentifiedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentIdentifiedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AgentIdentifiedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentIdentifiedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AgentIdentifiedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentIdentifiedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentIdentifiedBy doEndTag", e);
			throw new JspTagException("Exception raised in AgentIdentifiedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AgentIdentifiedByIterator");
