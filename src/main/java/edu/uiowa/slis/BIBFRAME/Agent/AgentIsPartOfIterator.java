...
public class AgentIsPartOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentIsPartOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentIsPartOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AgentIsPartOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentIsPartOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AgentIsPartOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentIsPartOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentIsPartOf doEndTag", e);
			throw new JspTagException("Exception raised in AgentIsPartOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AgentIsPartOfIterator");
