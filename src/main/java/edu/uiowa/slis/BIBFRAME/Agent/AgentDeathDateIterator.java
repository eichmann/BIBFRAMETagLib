...
public class AgentDeathDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentDeathDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentDeathDateIterator.class);
