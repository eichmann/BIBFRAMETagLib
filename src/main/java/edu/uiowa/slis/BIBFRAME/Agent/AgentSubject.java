...
public class AgentSubject extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AgentSubject currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentSubject.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentSubjectIterator.getSubject());
		} catch (Exception e) {
