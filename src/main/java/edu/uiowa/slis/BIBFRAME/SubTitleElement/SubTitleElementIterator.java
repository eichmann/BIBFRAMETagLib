...
public class SubTitleElementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SubTitleElementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SubTitleElementIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SubTitleElementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SubTitleElementIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in SubTitleElementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SubTitleElementIterator doAfterBody");
		}
