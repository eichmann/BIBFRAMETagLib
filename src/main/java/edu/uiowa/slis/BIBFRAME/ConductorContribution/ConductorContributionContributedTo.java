...
public class ConductorContributionContributedTo extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ConductorContributionContributedTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ConductorContributionContributedTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConductorContributionContributedToIterator.getContributedTo());
		} catch (Exception e) {
