...
public class OrderedCollection extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (this.getParent() instanceof edu.uiowa.slis.BIBFRAME.List.ListMemberListInverseIterator) {
				subjectURI = ((edu.uiowa.slis.BIBFRAME.List.ListMemberListInverseIterator)this.getParent()).getMemberListInverse();
			}
