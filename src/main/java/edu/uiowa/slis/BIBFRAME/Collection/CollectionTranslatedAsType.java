...
public class CollectionTranslatedAsType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionTranslatedAsType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionTranslatedAsType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionTranslatedAsIterator.getType());
		} catch (Exception e) {
