...
public class CollectionTranslatesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionTranslatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionTranslatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionTranslatesIterator.getType());
		} catch (Exception e) {
