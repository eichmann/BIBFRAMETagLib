...
public class CollectionSplitInto extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionSplitInto currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionSplitInto.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionSplitIntoIterator.getSplitInto());
		} catch (Exception e) {
