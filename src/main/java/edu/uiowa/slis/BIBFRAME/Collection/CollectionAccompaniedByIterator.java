...
public class CollectionAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CollectionAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CollectionAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollectionAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in CollectionAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CollectionAccompaniedByIterator");
