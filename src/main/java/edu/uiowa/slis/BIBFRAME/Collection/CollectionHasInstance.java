...
public class CollectionHasInstance extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionHasInstance currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasInstance.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionHasInstanceIterator.getHasInstance());
		} catch (Exception e) {
