...
public class CollectionTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionTemporalCoverageNoteIterator.class);
