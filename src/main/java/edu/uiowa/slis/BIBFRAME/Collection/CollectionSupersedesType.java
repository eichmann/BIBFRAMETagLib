...
public class CollectionSupersedesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionSupersedesType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionSupersedesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionSupersedesIterator.getType());
		} catch (Exception e) {
