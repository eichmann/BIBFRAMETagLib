...
public class CollectionHasDataSourceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionHasDataSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasDataSourceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollectionHasDataSourceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionHasDataSourceIterator doStartTag");
		}
