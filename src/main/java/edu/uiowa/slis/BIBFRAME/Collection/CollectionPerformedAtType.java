...
public class CollectionPerformedAtType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionPerformedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionPerformedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionPerformedAtIterator.getType());
		} catch (Exception e) {
