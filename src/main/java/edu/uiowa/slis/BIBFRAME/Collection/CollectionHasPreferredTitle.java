...
public class CollectionHasPreferredTitle extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionHasPreferredTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasPreferredTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionHasPreferredTitleIterator.getHasPreferredTitle());
		} catch (Exception e) {
