...
public class CollectionAbsorbedByType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionAbsorbedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionAbsorbedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionAbsorbedByIterator.getType());
		} catch (Exception e) {
