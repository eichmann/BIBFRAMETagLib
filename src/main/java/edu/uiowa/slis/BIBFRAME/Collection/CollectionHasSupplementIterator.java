...
public class CollectionHasSupplementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionHasSupplementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasSupplementIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CollectionHasSupplementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionHasSupplementIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CollectionHasSupplementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionHasSupplementIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollectionHasSupplement doEndTag", e);
			throw new JspTagException("Exception raised in CollectionHasSupplement doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CollectionHasSupplementIterator");
