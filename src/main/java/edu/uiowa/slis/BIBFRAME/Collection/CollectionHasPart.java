...
public class CollectionHasPart extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionHasPart currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasPart.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionHasPartIterator.getHasPart());
		} catch (Exception e) {
