...
public class CollectionFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionFormDesignationIterator.class);
