...
public class CollectionPrecedesInNarrativeInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionPrecedesInNarrativeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionPrecedesInNarrativeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollectionPrecedesInNarrativeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionPrecedesInNarrativeInverseIterator doStartTag");
		}
