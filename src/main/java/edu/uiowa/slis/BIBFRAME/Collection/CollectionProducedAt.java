...
public class CollectionProducedAt extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionProducedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionProducedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionProducedAtIterator.getProducedAt());
		} catch (Exception e) {
