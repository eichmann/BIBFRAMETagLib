...
public class CollectionPrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionPrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionPrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CollectionPrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionPrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CollectionPrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionPrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollectionPrecedes doEndTag", e);
			throw new JspTagException("Exception raised in CollectionPrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CollectionPrecedesIterator");
