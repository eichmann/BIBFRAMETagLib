...
public class CollectionAgentInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionAgentInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionAgentInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionAgentInverseIterator.getAgentInverse());
		} catch (Exception e) {
