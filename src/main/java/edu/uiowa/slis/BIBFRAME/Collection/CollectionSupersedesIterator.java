...
public class CollectionSupersedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionSupersedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionSupersedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CollectionSupersedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionSupersedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CollectionSupersedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionSupersedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollectionSupersedes doEndTag", e);
			throw new JspTagException("Exception raised in CollectionSupersedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CollectionSupersedesIterator");
