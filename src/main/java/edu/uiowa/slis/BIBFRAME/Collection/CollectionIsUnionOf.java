...
public class CollectionIsUnionOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CollectionIsUnionOf currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionIsUnionOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionIsUnionOfIterator.getIsUnionOf());
		} catch (Exception e) {
