...
public class CartographyLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyLanguageNoteIterator.class);
