...
public class CartographyIsLastOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyIsLastOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyIsLastOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCartographyIsLastOfIterator.getType());
		} catch (Exception e) {
