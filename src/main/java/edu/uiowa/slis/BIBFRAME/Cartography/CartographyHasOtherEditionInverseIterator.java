...
public class CartographyHasOtherEditionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyHasOtherEditionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyHasOtherEditionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CartographyHasOtherEditionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyHasOtherEditionInverseIterator doStartTag");
		}
