...
public class CartographyIsFindingAidForType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyIsFindingAidForType currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyIsFindingAidForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCartographyIsFindingAidForIterator.getType());
		} catch (Exception e) {
