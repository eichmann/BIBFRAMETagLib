...
public class CartographyHasSupplementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyHasSupplementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyHasSupplementIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CartographyHasSupplementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyHasSupplementIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CartographyHasSupplementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyHasSupplementIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CartographyHasSupplement doEndTag", e);
			throw new JspTagException("Exception raised in CartographyHasSupplement doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CartographyHasSupplementIterator");
