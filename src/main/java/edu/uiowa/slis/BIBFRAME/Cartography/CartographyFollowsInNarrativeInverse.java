...
public class CartographyFollowsInNarrativeInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyFollowsInNarrativeInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyFollowsInNarrativeInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCartographyFollowsInNarrativeInverseIterator.getFollowsInNarrativeInverse());
		} catch (Exception e) {
