...
public class CartographyAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CartographyAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CartographyAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CartographyAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in CartographyAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CartographyAccompaniedByIterator");
