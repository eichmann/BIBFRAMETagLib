...
public class CartographySplitInto extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographySplitInto currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographySplitInto.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCartographySplitIntoIterator.getSplitInto());
		} catch (Exception e) {
