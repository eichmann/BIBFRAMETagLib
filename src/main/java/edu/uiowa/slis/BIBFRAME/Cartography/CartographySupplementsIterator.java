...
public class CartographySupplementsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographySupplementsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographySupplementsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CartographySupplementsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographySupplementsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CartographySupplementsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographySupplementsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CartographySupplements doEndTag", e);
			throw new JspTagException("Exception raised in CartographySupplements doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CartographySupplementsIterator");
