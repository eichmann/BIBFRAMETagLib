...
public class CartographyContinuesUnderNewTitleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyContinuesUnderNewTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyContinuesUnderNewTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CartographyContinuesUnderNewTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyContinuesUnderNewTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CartographyContinuesUnderNewTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyContinuesUnderNewTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CartographyContinuesUnderNewTitle doEndTag", e);
			throw new JspTagException("Exception raised in CartographyContinuesUnderNewTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CartographyContinuesUnderNewTitleIterator");
