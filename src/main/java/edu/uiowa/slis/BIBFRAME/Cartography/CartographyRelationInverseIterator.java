...
public class CartographyRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CartographyRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CartographyRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographyRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CartographyRelation doEndTag", e);
			throw new JspTagException("Exception raised in CartographyRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CartographyRelationIterator");
