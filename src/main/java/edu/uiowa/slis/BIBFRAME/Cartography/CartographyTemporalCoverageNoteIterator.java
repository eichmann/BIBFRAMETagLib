...
public class CartographyTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyTemporalCoverageNoteIterator.class);
