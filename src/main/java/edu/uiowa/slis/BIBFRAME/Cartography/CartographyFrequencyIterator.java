...
public class CartographyFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyFrequencyIterator.class);
