...
public class CartographyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyIterator.class);
