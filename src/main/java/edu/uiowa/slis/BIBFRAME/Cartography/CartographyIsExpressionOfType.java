...
public class CartographyIsExpressionOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographyIsExpressionOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographyIsExpressionOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCartographyIsExpressionOfIterator.getType());
		} catch (Exception e) {
