...
public class CartographySupersedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CartographySupersedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CartographySupersedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CartographySupersedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographySupersedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CartographySupersedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CartographySupersedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CartographySupersedes doEndTag", e);
			throw new JspTagException("Exception raised in CartographySupersedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CartographySupersedesIterator");
