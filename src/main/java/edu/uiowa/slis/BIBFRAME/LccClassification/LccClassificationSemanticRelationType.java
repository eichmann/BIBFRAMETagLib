...
public class LccClassificationSemanticRelationType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LccClassificationSemanticRelationType currentInstance = null;
	private static final Log log = LogFactory.getLog(LccClassificationSemanticRelationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLccClassificationSemanticRelationIterator.getType());
		} catch (Exception e) {
