...
public class ItemIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ItemIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ItemIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/Item> . "+
