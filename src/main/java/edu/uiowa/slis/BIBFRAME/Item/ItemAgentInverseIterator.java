...
public class ItemAgentInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ItemAgentInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ItemAgentInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ItemAgentInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ItemAgentInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ItemAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ItemAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ItemAgent doEndTag", e);
			throw new JspTagException("Exception raised in ItemAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ItemAgentIterator");
