...
public class LinguisticSystemLanguageInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LinguisticSystemLanguageInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(LinguisticSystemLanguageInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLinguisticSystemLanguageInverseIterator.getLanguageInverse());
		} catch (Exception e) {
