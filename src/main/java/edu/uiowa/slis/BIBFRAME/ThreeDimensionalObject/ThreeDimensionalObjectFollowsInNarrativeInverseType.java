...
public class ThreeDimensionalObjectFollowsInNarrativeInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectFollowsInNarrativeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectFollowsInNarrativeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThreeDimensionalObjectFollowsInNarrativeInverseIterator.getType());
		} catch (Exception e) {
