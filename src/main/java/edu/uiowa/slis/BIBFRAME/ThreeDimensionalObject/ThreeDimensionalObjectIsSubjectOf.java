...
public class ThreeDimensionalObjectIsSubjectOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectIsSubjectOf currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectIsSubjectOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThreeDimensionalObjectIsSubjectOfIterator.getIsSubjectOf());
		} catch (Exception e) {
