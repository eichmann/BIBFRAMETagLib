...
public class ThreeDimensionalObjectSubjectIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectSubjectIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectSubjectIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThreeDimensionalObjectSubjectIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThreeDimensionalObjectSubjectIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThreeDimensionalObjectSubjectIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThreeDimensionalObjectSubjectIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThreeDimensionalObjectSubject doEndTag", e);
			throw new JspTagException("Exception raised in ThreeDimensionalObjectSubject doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThreeDimensionalObjectSubjectIterator");
