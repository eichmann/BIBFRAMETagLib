...
public class ThreeDimensionalObjectPrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectPrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectPrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThreeDimensionalObjectPrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThreeDimensionalObjectPrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThreeDimensionalObjectPrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThreeDimensionalObjectPrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThreeDimensionalObjectPrecedes doEndTag", e);
			throw new JspTagException("Exception raised in ThreeDimensionalObjectPrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThreeDimensionalObjectPrecedesIterator");
