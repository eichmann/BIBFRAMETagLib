...
public class ThreeDimensionalObjectAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
...
//					continue;
			...
			log.error("Exception raised in ThreeDimensionalObjectAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThreeDimensionalObjectAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThreeDimensionalObjectAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThreeDimensionalObjectAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThreeDimensionalObjectAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in ThreeDimensionalObjectAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThreeDimensionalObjectAccompaniesIterator");
