...
public class ThreeDimensionalObjectIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/ThreeDimensionalObject> . "+
