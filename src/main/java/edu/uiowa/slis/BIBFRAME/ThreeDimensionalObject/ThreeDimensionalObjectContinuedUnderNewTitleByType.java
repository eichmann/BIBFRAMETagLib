...
public class ThreeDimensionalObjectContinuedUnderNewTitleByType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectContinuedUnderNewTitleByType currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectContinuedUnderNewTitleByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThreeDimensionalObjectContinuedUnderNewTitleByIterator.getType());
		} catch (Exception e) {
