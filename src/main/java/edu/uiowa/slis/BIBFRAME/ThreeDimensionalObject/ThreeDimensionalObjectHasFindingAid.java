...
public class ThreeDimensionalObjectHasFindingAid extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectHasFindingAid currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectHasFindingAid.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThreeDimensionalObjectHasFindingAidIterator.getHasFindingAid());
		} catch (Exception e) {
