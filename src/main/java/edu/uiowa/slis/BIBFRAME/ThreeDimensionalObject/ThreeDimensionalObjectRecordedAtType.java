...
public class ThreeDimensionalObjectRecordedAtType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectRecordedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectRecordedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThreeDimensionalObjectRecordedAtIterator.getType());
		} catch (Exception e) {
