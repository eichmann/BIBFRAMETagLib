...
public class ThreeDimensionalObjectHasInstanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThreeDimensionalObjectHasInstanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThreeDimensionalObjectHasInstanceIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThreeDimensionalObjectHasInstanceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThreeDimensionalObjectHasInstanceIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThreeDimensionalObjectHasInstanceIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThreeDimensionalObjectHasInstanceIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThreeDimensionalObjectHasInstance doEndTag", e);
			throw new JspTagException("Exception raised in ThreeDimensionalObjectHasInstance doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setHasInstance(String theHasInstance) {
		hasInstance = theHasInstance;
	}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThreeDimensionalObjectHasInstanceIterator");
