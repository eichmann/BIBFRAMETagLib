...
public class AudioFollowsInNarrativeIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioFollowsInNarrativeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioFollowsInNarrativeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AudioFollowsInNarrativeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AudioFollowsInNarrativeIterator doStartTag");
		}
