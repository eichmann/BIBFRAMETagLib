...
public class AudioTranslatedAsType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioTranslatedAsType currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioTranslatedAsType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioTranslatedAsIterator.getType());
		} catch (Exception e) {
