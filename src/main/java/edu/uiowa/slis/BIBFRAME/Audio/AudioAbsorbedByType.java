...
public class AudioAbsorbedByType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioAbsorbedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioAbsorbedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioAbsorbedByIterator.getType());
		} catch (Exception e) {
