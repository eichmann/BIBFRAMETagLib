...
public class AudioFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioFormDesignationIterator.class);
