...
public class AudioIsSubjectOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioIsSubjectOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioIsSubjectOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AudioIsSubjectOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AudioIsSubjectOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AudioIsSubjectOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AudioIsSubjectOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AudioIsSubjectOf doEndTag", e);
			throw new JspTagException("Exception raised in AudioIsSubjectOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AudioIsSubjectOfIterator");
