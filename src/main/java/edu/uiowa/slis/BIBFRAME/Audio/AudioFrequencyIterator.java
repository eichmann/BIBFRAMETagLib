...
public class AudioFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioFrequencyIterator.class);
