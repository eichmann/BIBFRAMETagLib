...
public class AudioAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioAccompaniesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioAccompaniesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AudioAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AudioAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AudioAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AudioAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AudioAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in AudioAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AudioAccompaniesIterator");
