...
public class AudioIsFindingAidFor extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioIsFindingAidFor currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioIsFindingAidFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioIsFindingAidForIterator.getIsFindingAidFor());
		} catch (Exception e) {
