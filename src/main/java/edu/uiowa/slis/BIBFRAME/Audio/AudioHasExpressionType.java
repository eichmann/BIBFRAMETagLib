...
public class AudioHasExpressionType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioHasExpressionType currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioHasExpressionType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioHasExpressionIterator.getType());
		} catch (Exception e) {
