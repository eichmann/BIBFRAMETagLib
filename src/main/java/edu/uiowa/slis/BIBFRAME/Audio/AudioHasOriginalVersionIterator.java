...
public class AudioHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioHasOriginalVersionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AudioHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AudioHasOriginalVersionIterator doStartTag");
		}
