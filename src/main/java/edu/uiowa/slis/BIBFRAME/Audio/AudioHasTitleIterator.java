...
public class AudioHasTitleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioHasTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioHasTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AudioHasTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AudioHasTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AudioHasTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AudioHasTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AudioHasTitle doEndTag", e);
			throw new JspTagException("Exception raised in AudioHasTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AudioHasTitleIterator");
