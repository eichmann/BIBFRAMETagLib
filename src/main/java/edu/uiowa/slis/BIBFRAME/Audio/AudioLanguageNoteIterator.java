...
public class AudioLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioLanguageNoteIterator.class);
