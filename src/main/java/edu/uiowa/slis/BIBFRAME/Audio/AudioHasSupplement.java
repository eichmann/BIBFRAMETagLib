...
public class AudioHasSupplement extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AudioHasSupplement currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioHasSupplement.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioHasSupplementIterator.getHasSupplement());
		} catch (Exception e) {
