...
public class NlmShelfMarkTopConceptOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NlmShelfMarkTopConceptOf currentInstance = null;
	private static final Log log = LogFactory.getLog(NlmShelfMarkTopConceptOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNlmShelfMarkTopConceptOfIterator.getTopConceptOf());
		} catch (Exception e) {
