...
public class WorkFollowsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkFollowsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkFollowsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in WorkFollowsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkFollowsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in WorkFollowsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkFollowsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in WorkFollows doEndTag", e);
			throw new JspTagException("Exception raised in WorkFollows doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to WorkFollowsIterator");
