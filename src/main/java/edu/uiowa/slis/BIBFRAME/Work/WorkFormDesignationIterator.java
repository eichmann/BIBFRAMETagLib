...
public class WorkFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkFormDesignationIterator.class);
