...
public class WorkBirthDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkBirthDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkBirthDateIterator.class);
