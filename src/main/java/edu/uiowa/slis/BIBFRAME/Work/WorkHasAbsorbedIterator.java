...
public class WorkHasAbsorbedIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkHasAbsorbedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkHasAbsorbedIterator.class);
...
//					continue;
			...
			log.error("Exception raised in WorkHasAbsorbedIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkHasAbsorbedIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in WorkHasAbsorbedIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkHasAbsorbedIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in WorkHasAbsorbed doEndTag", e);
			throw new JspTagException("Exception raised in WorkHasAbsorbed doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to WorkHasAbsorbedIterator");
