...
public class WorkPrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkPrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkPrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in WorkPrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkPrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in WorkPrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkPrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in WorkPrecedes doEndTag", e);
			throw new JspTagException("Exception raised in WorkPrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to WorkPrecedesIterator");
