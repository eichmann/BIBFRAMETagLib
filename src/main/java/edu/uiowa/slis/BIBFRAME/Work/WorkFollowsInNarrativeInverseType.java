...
public class WorkFollowsInNarrativeInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkFollowsInNarrativeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkFollowsInNarrativeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWorkFollowsInNarrativeInverseIterator.getType());
		} catch (Exception e) {
