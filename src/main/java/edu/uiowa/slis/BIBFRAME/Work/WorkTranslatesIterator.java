...
public class WorkTranslatesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkTranslatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkTranslatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in WorkTranslatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkTranslatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in WorkTranslatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkTranslatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in WorkTranslates doEndTag", e);
			throw new JspTagException("Exception raised in WorkTranslates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to WorkTranslatesIterator");
