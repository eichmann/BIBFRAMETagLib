...
public class WorkRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in WorkRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in WorkRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in WorkRelation doEndTag", e);
			throw new JspTagException("Exception raised in WorkRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to WorkRelationIterator");
