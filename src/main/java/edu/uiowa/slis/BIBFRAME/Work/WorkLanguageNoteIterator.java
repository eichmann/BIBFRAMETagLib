...
public class WorkLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkLanguageNoteIterator.class);
