...
public class WorkIdentifiedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkIdentifiedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkIdentifiedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in WorkIdentifiedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkIdentifiedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in WorkIdentifiedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkIdentifiedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in WorkIdentifiedBy doEndTag", e);
			throw new JspTagException("Exception raised in WorkIdentifiedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to WorkIdentifiedByIterator");
