...
public class WorkHasInstanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkHasInstanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkHasInstanceIterator.class);
...
//					continue;
			...
			log.error("Exception raised in WorkHasInstanceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkHasInstanceIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in WorkHasInstanceIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in WorkHasInstanceIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in WorkHasInstance doEndTag", e);
			throw new JspTagException("Exception raised in WorkHasInstance doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to WorkHasInstanceIterator");
