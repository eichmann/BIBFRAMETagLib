...
public class WorkNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static WorkNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkNameIterator.class);
