...
public class EventBirthDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventBirthDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventBirthDateIterator.class);
