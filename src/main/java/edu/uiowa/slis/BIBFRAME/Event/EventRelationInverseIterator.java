...
public class EventRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in EventRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in EventRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EventRelation doEndTag", e);
			throw new JspTagException("Exception raised in EventRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to EventRelationIterator");
