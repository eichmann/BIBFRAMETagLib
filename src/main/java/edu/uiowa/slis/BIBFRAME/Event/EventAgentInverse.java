...
public class EventAgentInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventAgentInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(EventAgentInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventAgentInverseIterator.getAgentInverse());
		} catch (Exception e) {
