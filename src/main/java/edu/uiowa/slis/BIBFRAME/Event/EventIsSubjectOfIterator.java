...
public class EventIsSubjectOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventIsSubjectOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventIsSubjectOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in EventIsSubjectOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventIsSubjectOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in EventIsSubjectOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventIsSubjectOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EventIsSubjectOf doEndTag", e);
			throw new JspTagException("Exception raised in EventIsSubjectOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to EventIsSubjectOfIterator");
