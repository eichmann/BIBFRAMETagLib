...
public class EventHasAnnotationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventHasAnnotationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasAnnotationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in EventHasAnnotationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventHasAnnotationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in EventHasAnnotationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventHasAnnotationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EventHasAnnotation doEndTag", e);
			throw new JspTagException("Exception raised in EventHasAnnotation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to EventHasAnnotationIterator");
