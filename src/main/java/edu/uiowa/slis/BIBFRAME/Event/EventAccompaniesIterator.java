...
public class EventAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventAccompaniesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventAccompaniesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in EventAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in EventAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EventAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in EventAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to EventAccompaniesIterator");
