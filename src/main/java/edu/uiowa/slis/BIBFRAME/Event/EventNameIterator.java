...
public class EventNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameIterator.class);
