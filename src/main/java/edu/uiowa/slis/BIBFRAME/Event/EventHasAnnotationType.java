...
public class EventHasAnnotationType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventHasAnnotationType currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasAnnotationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventHasAnnotationIterator.getType());
		} catch (Exception e) {
