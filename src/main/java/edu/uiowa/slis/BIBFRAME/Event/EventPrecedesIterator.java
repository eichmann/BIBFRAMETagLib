...
public class EventPrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventPrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventPrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in EventPrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventPrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in EventPrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventPrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EventPrecedes doEndTag", e);
			throw new JspTagException("Exception raised in EventPrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to EventPrecedesIterator");
