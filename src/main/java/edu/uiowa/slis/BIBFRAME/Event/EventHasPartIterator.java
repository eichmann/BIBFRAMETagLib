...
public class EventHasPartIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EventHasPartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasPartIterator.class);
...
//					continue;
			...
			log.error("Exception raised in EventHasPartIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventHasPartIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in EventHasPartIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EventHasPartIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EventHasPart doEndTag", e);
			throw new JspTagException("Exception raised in EventHasPart doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to EventHasPartIterator");
