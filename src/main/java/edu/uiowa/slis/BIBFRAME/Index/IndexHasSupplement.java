...
public class IndexHasSupplement extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexHasSupplement currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexHasSupplement.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndexHasSupplementIterator.getHasSupplement());
		} catch (Exception e) {
