...
public class IndexIsUnionOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexIsUnionOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexIsUnionOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndexIsUnionOfIterator.getType());
		} catch (Exception e) {
