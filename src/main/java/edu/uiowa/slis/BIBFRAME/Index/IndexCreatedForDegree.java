...
public class IndexCreatedForDegree extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexCreatedForDegree currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexCreatedForDegree.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndexCreatedForDegreeIterator.getCreatedForDegree());
		} catch (Exception e) {
