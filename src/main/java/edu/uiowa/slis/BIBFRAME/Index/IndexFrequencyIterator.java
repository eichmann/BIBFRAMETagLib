...
public class IndexFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexFrequencyIterator.class);
