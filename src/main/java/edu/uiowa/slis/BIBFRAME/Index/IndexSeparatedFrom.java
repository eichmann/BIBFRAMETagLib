...
public class IndexSeparatedFrom extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexSeparatedFrom currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexSeparatedFrom.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndexSeparatedFromIterator.getSeparatedFrom());
		} catch (Exception e) {
