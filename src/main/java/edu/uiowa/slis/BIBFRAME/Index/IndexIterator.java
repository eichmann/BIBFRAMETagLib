...
public class IndexIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexIterator currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://bib.ld4l.org/ontology/Index> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
