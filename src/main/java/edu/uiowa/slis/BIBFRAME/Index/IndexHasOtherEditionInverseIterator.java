...
public class IndexHasOtherEditionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexHasOtherEditionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexHasOtherEditionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IndexHasOtherEditionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IndexHasOtherEditionInverseIterator doStartTag");
		}
