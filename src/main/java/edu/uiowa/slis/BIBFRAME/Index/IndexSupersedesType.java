...
public class IndexSupersedesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexSupersedesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexSupersedesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndexSupersedesIterator.getType());
		} catch (Exception e) {
