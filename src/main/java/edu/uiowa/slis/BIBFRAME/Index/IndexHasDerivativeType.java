...
public class IndexHasDerivativeType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexHasDerivativeType currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexHasDerivativeType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndexHasDerivativeIterator.getType());
		} catch (Exception e) {
