...
public class IndexPrecedesInNarrativeInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexPrecedesInNarrativeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexPrecedesInNarrativeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IndexPrecedesInNarrativeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IndexPrecedesInNarrativeInverseIterator doStartTag");
		}
