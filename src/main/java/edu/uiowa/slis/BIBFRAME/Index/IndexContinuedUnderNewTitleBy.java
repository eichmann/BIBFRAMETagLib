...
public class IndexContinuedUnderNewTitleBy extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexContinuedUnderNewTitleBy currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexContinuedUnderNewTitleBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndexContinuedUnderNewTitleByIterator.getContinuedUnderNewTitleBy());
		} catch (Exception e) {
