...
public class IndexIdentifiedByType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexIdentifiedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexIdentifiedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndexIdentifiedByIterator.getType());
		} catch (Exception e) {
