...
public class IndexLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IndexLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndexLanguageNoteIterator.class);
