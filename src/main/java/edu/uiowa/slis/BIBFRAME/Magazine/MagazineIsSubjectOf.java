...
public class MagazineIsSubjectOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazineIsSubjectOf currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineIsSubjectOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMagazineIsSubjectOfIterator.getIsSubjectOf());
		} catch (Exception e) {
