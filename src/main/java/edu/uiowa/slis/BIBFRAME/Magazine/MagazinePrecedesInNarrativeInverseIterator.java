...
public class MagazinePrecedesInNarrativeInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazinePrecedesInNarrativeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazinePrecedesInNarrativeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MagazinePrecedesInNarrativeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MagazinePrecedesInNarrativeInverseIterator doStartTag");
		}
