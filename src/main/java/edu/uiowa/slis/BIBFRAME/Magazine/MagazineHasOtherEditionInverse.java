...
public class MagazineHasOtherEditionInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazineHasOtherEditionInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineHasOtherEditionInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMagazineHasOtherEditionInverseIterator.getHasOtherEditionInverse());
		} catch (Exception e) {
