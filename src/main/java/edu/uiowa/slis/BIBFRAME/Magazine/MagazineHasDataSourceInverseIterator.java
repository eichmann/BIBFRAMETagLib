...
public class MagazineHasDataSourceInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazineHasDataSourceInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineHasDataSourceInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MagazineHasDataSourceInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MagazineHasDataSourceInverseIterator doStartTag");
		}
