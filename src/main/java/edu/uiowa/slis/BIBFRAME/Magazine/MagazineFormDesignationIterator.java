...
public class MagazineFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazineFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineFormDesignationIterator.class);
