...
public class MagazineHasDataSourceType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazineHasDataSourceType currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineHasDataSourceType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMagazineHasDataSourceIterator.getType());
		} catch (Exception e) {
