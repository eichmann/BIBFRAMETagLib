...
public class MagazineHasOtherEditionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazineHasOtherEditionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineHasOtherEditionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MagazineHasOtherEditionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MagazineHasOtherEditionInverseIterator doStartTag");
		}
