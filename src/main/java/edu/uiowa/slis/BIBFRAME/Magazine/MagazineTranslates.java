...
public class MagazineTranslates extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazineTranslates currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineTranslates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMagazineTranslatesIterator.getTranslates());
		} catch (Exception e) {
