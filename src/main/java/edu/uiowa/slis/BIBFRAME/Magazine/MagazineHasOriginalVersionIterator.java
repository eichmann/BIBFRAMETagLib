...
public class MagazineHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MagazineHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineHasOriginalVersionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MagazineHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MagazineHasOriginalVersionIterator doStartTag");
		}
