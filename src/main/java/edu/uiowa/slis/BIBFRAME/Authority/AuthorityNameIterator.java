...
public class AuthorityNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static AuthorityNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorityNameIterator.class);
