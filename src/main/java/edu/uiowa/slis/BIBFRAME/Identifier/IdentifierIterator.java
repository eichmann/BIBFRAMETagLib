...
public class IdentifierIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IdentifierIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IdentifierIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IdentifierIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in IdentifierIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IdentifierIterator doAfterBody");
		}
