...
public class EditorContributionAgentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static EditorContributionAgentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorContributionAgentIterator.class);
...
//					continue;
			...
			log.error("Exception raised in EditorContributionAgentIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EditorContributionAgentIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in EditorContributionAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EditorContributionAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EditorContributionAgent doEndTag", e);
			throw new JspTagException("Exception raised in EditorContributionAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to EditorContributionAgentIterator");
