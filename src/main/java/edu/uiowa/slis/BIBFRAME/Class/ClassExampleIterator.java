...
public class ClassExampleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ClassExampleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassExampleIterator.class);
