...
public class ClassEditorialNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ClassEditorialNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassEditorialNoteIterator.class);
