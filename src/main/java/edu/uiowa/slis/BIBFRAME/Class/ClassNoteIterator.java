...
public class ClassNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ClassNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassNoteIterator.class);
