...
public class NothingIdentifiedByType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NothingIdentifiedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingIdentifiedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNothingIdentifiedByIterator.getType());
		} catch (Exception e) {
