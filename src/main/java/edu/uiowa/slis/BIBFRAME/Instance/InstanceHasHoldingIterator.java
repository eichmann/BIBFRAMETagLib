...
public class InstanceHasHoldingIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceHasHoldingIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceHasHoldingIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstanceHasHoldingIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceHasHoldingIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstanceHasHoldingIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceHasHoldingIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceHasHolding doEndTag", e);
			throw new JspTagException("Exception raised in InstanceHasHolding doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstanceHasHoldingIterator");
