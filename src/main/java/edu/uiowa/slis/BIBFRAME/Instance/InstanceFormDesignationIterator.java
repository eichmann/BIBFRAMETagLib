...
public class InstanceFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceFormDesignationIterator.class);
