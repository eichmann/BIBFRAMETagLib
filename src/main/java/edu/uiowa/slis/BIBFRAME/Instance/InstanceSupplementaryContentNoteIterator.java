...
public class InstanceSupplementaryContentNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceSupplementaryContentNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceSupplementaryContentNoteIterator.class);
