...
public class InstanceIssuedWithInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceIssuedWithInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceIssuedWithInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceIssuedWithInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceIssuedWithInverseIterator doStartTag");
		}
