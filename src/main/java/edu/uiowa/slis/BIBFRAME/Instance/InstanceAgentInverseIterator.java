...
public class InstanceAgentInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceAgentInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceAgentInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstanceAgentInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceAgentInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstanceAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceAgent doEndTag", e);
			throw new JspTagException("Exception raised in InstanceAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstanceAgentIterator");
