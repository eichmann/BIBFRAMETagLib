...
public class InstanceGraphicScaleNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceGraphicScaleNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceGraphicScaleNoteIterator.class);
