...
public class InstancePrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstancePrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstancePrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstancePrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstancePrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstancePrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstancePrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstancePrecedes doEndTag", e);
			throw new JspTagException("Exception raised in InstancePrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstancePrecedesIterator");
