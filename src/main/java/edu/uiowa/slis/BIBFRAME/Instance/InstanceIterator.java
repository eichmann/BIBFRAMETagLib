...
public class InstanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/Instance> . "+
