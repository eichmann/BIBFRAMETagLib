...
public class InstanceEquivalentToInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceEquivalentToInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceEquivalentToInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceEquivalentToInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceEquivalentToInverseIterator doStartTag");
		}
