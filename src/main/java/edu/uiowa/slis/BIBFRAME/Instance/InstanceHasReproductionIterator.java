...
public class InstanceHasReproductionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceHasReproductionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceHasReproductionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstanceHasReproductionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceHasReproductionIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstanceHasReproductionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceHasReproductionIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceHasReproduction doEndTag", e);
			throw new JspTagException("Exception raised in InstanceHasReproduction doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setHasReproduction(String theHasReproduction) {
		hasReproduction = theHasReproduction;
	}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstanceHasReproductionIterator");
