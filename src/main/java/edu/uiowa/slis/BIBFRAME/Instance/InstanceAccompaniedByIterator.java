...
public class InstanceAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstanceAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstanceAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in InstanceAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstanceAccompaniedByIterator");
