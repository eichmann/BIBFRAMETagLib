...
public class InstanceFormatOfMusicIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceFormatOfMusicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceFormatOfMusicIterator.class);
