...
public class InstanceNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceNameIterator.class);
