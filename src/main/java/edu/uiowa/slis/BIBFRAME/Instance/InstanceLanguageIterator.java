...
public class InstanceLanguageIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceLanguageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceLanguageIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstanceLanguageIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceLanguageIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstanceLanguageIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceLanguageIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceLanguage doEndTag", e);
			throw new JspTagException("Exception raised in InstanceLanguage doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstanceLanguageIterator");
