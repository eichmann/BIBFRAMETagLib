...
public class InstanceFollowsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceFollowsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceFollowsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstanceFollowsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceFollowsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstanceFollowsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceFollowsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceFollows doEndTag", e);
			throw new JspTagException("Exception raised in InstanceFollows doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstanceFollowsIterator");
