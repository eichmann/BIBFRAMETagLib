...
public class InstanceCustodialHistoryIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceCustodialHistoryIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceCustodialHistoryIterator.class);
