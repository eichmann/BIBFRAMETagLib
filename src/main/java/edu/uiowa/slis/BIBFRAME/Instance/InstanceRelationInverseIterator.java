...
public class InstanceRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstanceRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstanceRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceRelation doEndTag", e);
			throw new JspTagException("Exception raised in InstanceRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstanceRelationIterator");
