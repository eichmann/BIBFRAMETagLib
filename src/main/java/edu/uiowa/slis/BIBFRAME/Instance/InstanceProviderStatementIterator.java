...
public class InstanceProviderStatementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceProviderStatementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceProviderStatementIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://bib.ld4l.org/ontology/legacy/providerStatement> ?s } ");
			if(rs.hasNext()) {
