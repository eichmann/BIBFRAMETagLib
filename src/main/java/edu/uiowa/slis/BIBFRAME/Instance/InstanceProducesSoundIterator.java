...
public class InstanceProducesSoundIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceProducesSoundIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceProducesSoundIterator.class);
