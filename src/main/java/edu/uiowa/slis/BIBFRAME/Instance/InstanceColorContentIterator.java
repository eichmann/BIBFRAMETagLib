...
public class InstanceColorContentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceColorContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceColorContentIterator.class);
