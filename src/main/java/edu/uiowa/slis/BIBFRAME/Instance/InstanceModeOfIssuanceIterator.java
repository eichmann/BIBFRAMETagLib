...
public class InstanceModeOfIssuanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceModeOfIssuanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceModeOfIssuanceIterator.class);
