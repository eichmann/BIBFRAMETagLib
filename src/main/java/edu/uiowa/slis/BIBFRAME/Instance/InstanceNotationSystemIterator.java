...
public class InstanceNotationSystemIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceNotationSystemIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceNotationSystemIterator.class);
