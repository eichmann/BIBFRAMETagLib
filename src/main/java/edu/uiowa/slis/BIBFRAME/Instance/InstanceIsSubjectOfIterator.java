...
public class InstanceIsSubjectOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InstanceIsSubjectOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstanceIsSubjectOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in InstanceIsSubjectOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceIsSubjectOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in InstanceIsSubjectOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstanceIsSubjectOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstanceIsSubjectOf doEndTag", e);
			throw new JspTagException("Exception raised in InstanceIsSubjectOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to InstanceIsSubjectOfIterator");
