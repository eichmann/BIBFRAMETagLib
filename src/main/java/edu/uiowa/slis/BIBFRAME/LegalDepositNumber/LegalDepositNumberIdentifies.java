...
public class LegalDepositNumberIdentifies extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static LegalDepositNumberIdentifies currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDepositNumberIdentifies.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDepositNumberIdentifiesIterator.getIdentifies());
		} catch (Exception e) {
