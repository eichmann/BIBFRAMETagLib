...
public class TitleElementFollows extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TitleElementFollows currentInstance = null;
	private static final Log log = LogFactory.getLog(TitleElementFollows.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTitleElementFollowsIterator.getFollows());
		} catch (Exception e) {
