...
public class TitleElementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TitleElementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TitleElementIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.loc.gov/mads/rdf/v1#TitleElement> . "+
			...
			log.error("Exception raised in TitleElementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TitleElementIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in TitleElementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TitleElementIterator doAfterBody");
		}
