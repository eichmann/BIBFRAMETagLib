...
public class BinderTitleHasPart extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static BinderTitleHasPart currentInstance = null;
	private static final Log log = LogFactory.getLog(BinderTitleHasPart.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBinderTitleHasPartIterator.getHasPart());
		} catch (Exception e) {
