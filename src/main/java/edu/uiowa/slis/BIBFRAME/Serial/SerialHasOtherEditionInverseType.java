...
public class SerialHasOtherEditionInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialHasOtherEditionInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialHasOtherEditionInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialHasOtherEditionInverseIterator.getType());
		} catch (Exception e) {
