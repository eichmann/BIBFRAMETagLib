...
public class SerialRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialRelationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in SerialRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialRelationIterator doStartTag");
		}
