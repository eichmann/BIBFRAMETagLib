...
public class SerialCreatedForDegree extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialCreatedForDegree currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialCreatedForDegree.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialCreatedForDegreeIterator.getCreatedForDegree());
		} catch (Exception e) {
