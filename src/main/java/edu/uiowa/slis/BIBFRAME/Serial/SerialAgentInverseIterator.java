...
public class SerialAgentInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialAgentInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialAgentInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in SerialAgentInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialAgentInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in SerialAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SerialAgent doEndTag", e);
			throw new JspTagException("Exception raised in SerialAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to SerialAgentIterator");
