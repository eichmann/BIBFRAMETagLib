...
public class SerialSubject extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialSubject currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialSubject.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialSubjectIterator.getSubject());
		} catch (Exception e) {
