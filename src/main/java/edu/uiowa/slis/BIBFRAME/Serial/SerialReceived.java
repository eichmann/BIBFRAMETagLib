...
public class SerialReceived extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialReceived currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialReceived.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialReceivedIterator.getReceived());
		} catch (Exception e) {
