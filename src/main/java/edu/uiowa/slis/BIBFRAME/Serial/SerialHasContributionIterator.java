...
public class SerialHasContributionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialHasContributionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialHasContributionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in SerialHasContributionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialHasContributionIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in SerialHasContributionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialHasContributionIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SerialHasContribution doEndTag", e);
			throw new JspTagException("Exception raised in SerialHasContribution doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to SerialHasContributionIterator");
