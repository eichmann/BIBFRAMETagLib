...
public class SerialPrecedesInNarrativeIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialPrecedesInNarrativeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialPrecedesInNarrativeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SerialPrecedesInNarrativeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialPrecedesInNarrativeIterator doStartTag");
		}
