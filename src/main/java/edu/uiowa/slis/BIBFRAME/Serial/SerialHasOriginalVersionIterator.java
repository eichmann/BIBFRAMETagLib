...
public class SerialHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialHasOriginalVersionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in SerialHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialHasOriginalVersionIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in SerialHasOriginalVersionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialHasOriginalVersionIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SerialHasOriginalVersion doEndTag", e);
			throw new JspTagException("Exception raised in SerialHasOriginalVersion doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to SerialHasOriginalVersionIterator");
