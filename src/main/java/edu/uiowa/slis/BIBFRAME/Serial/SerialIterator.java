...
public class SerialIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/Serial> . "+
