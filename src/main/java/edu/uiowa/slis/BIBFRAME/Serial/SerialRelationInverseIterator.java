...
public class SerialRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in SerialRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in SerialRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SerialRelation doEndTag", e);
			throw new JspTagException("Exception raised in SerialRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to SerialRelationIterator");
