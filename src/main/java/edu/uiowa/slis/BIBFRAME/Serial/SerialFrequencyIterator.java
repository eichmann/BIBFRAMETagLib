...
public class SerialFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialFrequencyIterator.class);
