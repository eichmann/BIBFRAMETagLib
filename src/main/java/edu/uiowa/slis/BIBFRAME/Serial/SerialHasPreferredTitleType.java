...
public class SerialHasPreferredTitleType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialHasPreferredTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialHasPreferredTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialHasPreferredTitleIterator.getType());
		} catch (Exception e) {
