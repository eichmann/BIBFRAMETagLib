...
public class SerialSupplementsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialSupplementsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialSupplementsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in SerialSupplementsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialSupplementsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in SerialSupplementsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialSupplementsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SerialSupplements doEndTag", e);
			throw new JspTagException("Exception raised in SerialSupplements doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to SerialSupplementsIterator");
