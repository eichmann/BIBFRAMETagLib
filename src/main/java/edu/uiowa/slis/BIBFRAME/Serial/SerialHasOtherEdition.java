...
public class SerialHasOtherEdition extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialHasOtherEdition currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialHasOtherEdition.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialHasOtherEditionIterator.getHasOtherEdition());
		} catch (Exception e) {
