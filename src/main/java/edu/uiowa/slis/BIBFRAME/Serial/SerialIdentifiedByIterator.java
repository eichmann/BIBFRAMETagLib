...
public class SerialIdentifiedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialIdentifiedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialIdentifiedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in SerialIdentifiedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialIdentifiedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in SerialIdentifiedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SerialIdentifiedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SerialIdentifiedBy doEndTag", e);
			throw new JspTagException("Exception raised in SerialIdentifiedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to SerialIdentifiedByIterator");
