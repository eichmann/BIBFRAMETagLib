...
public class SerialHasDataSourceInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialHasDataSourceInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialHasDataSourceInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialHasDataSourceInverseIterator.getHasDataSourceInverse());
		} catch (Exception e) {
