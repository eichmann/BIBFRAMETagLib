...
public class SerialHasPartType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialHasPartType currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialHasPartType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialHasPartIterator.getType());
		} catch (Exception e) {
