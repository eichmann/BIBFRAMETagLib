...
public class SerialIsExpressionOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SerialIsExpressionOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(SerialIsExpressionOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSerialIsExpressionOfIterator.getType());
		} catch (Exception e) {
