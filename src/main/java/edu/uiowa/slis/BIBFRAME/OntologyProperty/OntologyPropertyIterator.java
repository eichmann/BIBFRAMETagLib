...
public class OntologyPropertyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static OntologyPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OntologyPropertyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.w3.org/2002/07/owl#OntologyProperty> . "+
			...
			log.error("Exception raised in OntologyPropertyIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OntologyPropertyIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in OntologyPropertyIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OntologyPropertyIterator doAfterBody");
		}
