...
public class GovernmentOrganizationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static GovernmentOrganizationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentOrganizationIterator.class);
