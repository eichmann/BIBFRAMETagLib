...
public class GovernmentOrganizationDeathDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static GovernmentOrganizationDeathDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentOrganizationDeathDateIterator.class);
