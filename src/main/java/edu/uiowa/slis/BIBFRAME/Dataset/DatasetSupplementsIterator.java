...
public class DatasetSupplementsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetSupplementsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetSupplementsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetSupplementsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetSupplementsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetSupplementsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetSupplementsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetSupplements doEndTag", e);
			throw new JspTagException("Exception raised in DatasetSupplements doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetSupplementsIterator");
