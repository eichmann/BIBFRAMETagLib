...
public class DatasetRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetRelation doEndTag", e);
			throw new JspTagException("Exception raised in DatasetRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetRelationIterator");
