...
public class DatasetDerivedFrom extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetDerivedFrom currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetDerivedFrom.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetDerivedFromIterator.getDerivedFrom());
		} catch (Exception e) {
