...
public class DatasetTranslatesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetTranslatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetTranslatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetTranslatesIterator.getType());
		} catch (Exception e) {
