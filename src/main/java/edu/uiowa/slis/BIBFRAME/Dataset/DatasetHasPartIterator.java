...
public class DatasetHasPartIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasPartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasPartIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetHasPartIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasPartIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetHasPartIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasPartIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetHasPart doEndTag", e);
			throw new JspTagException("Exception raised in DatasetHasPart doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetHasPartIterator");
