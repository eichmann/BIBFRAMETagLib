...
public class DatasetHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasOriginalVersionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasOriginalVersionIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetHasOriginalVersionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasOriginalVersionIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetHasOriginalVersion doEndTag", e);
			throw new JspTagException("Exception raised in DatasetHasOriginalVersion doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetHasOriginalVersionIterator");
