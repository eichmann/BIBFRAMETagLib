...
public class DatasetSupplements extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetSupplements currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetSupplements.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetSupplementsIterator.getSupplements());
		} catch (Exception e) {
