...
public class DatasetFollowsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetFollowsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetFollowsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetFollowsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetFollowsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetFollowsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetFollowsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetFollows doEndTag", e);
			throw new JspTagException("Exception raised in DatasetFollows doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetFollowsIterator");
