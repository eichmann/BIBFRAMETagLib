...
public class DatasetHasPreferredTitleType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasPreferredTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasPreferredTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetHasPreferredTitleIterator.getType());
		} catch (Exception e) {
