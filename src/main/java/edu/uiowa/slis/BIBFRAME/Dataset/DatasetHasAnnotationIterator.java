...
public class DatasetHasAnnotationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasAnnotationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasAnnotationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetHasAnnotationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasAnnotationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetHasAnnotationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasAnnotationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetHasAnnotation doEndTag", e);
			throw new JspTagException("Exception raised in DatasetHasAnnotation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetHasAnnotationIterator");
