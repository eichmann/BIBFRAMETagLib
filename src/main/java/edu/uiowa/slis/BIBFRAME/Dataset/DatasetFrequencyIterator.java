...
public class DatasetFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetFrequencyIterator.class);
