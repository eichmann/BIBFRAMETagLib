...
public class DatasetTranslatedAsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetTranslatedAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetTranslatedAsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetTranslatedAsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetTranslatedAsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetTranslatedAsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetTranslatedAsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetTranslatedAs doEndTag", e);
			throw new JspTagException("Exception raised in DatasetTranslatedAs doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetTranslatedAsIterator");
