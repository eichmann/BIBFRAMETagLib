...
public class DatasetAccompaniedByType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetAccompaniedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetAccompaniedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetAccompaniedByIterator.getType());
		} catch (Exception e) {
