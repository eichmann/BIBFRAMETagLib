...
public class DatasetHasOtherEditionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasOtherEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasOtherEditionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetHasOtherEditionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasOtherEditionIterator doStartTag");
		}
