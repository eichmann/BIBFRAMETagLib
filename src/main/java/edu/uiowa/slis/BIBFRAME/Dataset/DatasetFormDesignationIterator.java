...
public class DatasetFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetFormDesignationIterator.class);
