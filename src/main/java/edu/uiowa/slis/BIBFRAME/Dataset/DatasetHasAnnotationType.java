...
public class DatasetHasAnnotationType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasAnnotationType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasAnnotationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetHasAnnotationIterator.getType());
		} catch (Exception e) {
