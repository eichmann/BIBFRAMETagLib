...
public class DatasetLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetLanguageNoteIterator.class);
