...
public class DatasetFollowsInNarrativeInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetFollowsInNarrativeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetFollowsInNarrativeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetFollowsInNarrativeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetFollowsInNarrativeInverseIterator doStartTag");
		}
