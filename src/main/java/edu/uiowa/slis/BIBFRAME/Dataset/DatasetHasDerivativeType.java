...
public class DatasetHasDerivativeType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasDerivativeType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasDerivativeType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetHasDerivativeIterator.getType());
		} catch (Exception e) {
