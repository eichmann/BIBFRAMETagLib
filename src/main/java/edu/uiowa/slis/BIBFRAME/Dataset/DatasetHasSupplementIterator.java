...
public class DatasetHasSupplementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasSupplementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasSupplementIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetHasSupplementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasSupplementIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetHasSupplementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetHasSupplementIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetHasSupplement doEndTag", e);
			throw new JspTagException("Exception raised in DatasetHasSupplement doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetHasSupplementIterator");
