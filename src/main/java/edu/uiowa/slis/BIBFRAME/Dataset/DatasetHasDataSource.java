...
public class DatasetHasDataSource extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasDataSource currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasDataSource.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetHasDataSourceIterator.getHasDataSource());
		} catch (Exception e) {
