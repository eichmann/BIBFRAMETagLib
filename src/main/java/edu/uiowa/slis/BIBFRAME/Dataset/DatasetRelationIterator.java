...
public class DatasetRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetRelationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetRelationIterator doStartTag");
		}
