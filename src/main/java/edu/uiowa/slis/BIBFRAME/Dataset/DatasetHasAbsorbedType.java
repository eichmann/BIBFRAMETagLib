...
public class DatasetHasAbsorbedType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetHasAbsorbedType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasAbsorbedType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetHasAbsorbedIterator.getType());
		} catch (Exception e) {
