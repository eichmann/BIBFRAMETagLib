...
public class DatasetTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatasetTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetTemporalCoverageNoteIterator.class);
