...
public class FiniteResourceIsSubjectOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceIsSubjectOf currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceIsSubjectOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceIsSubjectOfIterator.getIsSubjectOf());
		} catch (Exception e) {
