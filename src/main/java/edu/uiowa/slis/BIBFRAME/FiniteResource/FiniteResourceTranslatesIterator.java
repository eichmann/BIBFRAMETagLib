...
public class FiniteResourceTranslatesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceTranslatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceTranslatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceTranslatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceTranslatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceTranslatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceTranslatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceTranslates doEndTag", e);
			throw new JspTagException("Exception raised in FiniteResourceTranslates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FiniteResourceTranslatesIterator");
