...
public class FiniteResourceHasOtherEdition extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceHasOtherEdition currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceHasOtherEdition.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceHasOtherEditionIterator.getHasOtherEdition());
		} catch (Exception e) {
