...
public class FiniteResourceSeparatedFrom extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceSeparatedFrom currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceSeparatedFrom.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceSeparatedFromIterator.getSeparatedFrom());
		} catch (Exception e) {
