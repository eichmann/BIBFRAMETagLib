...
public class FiniteResourceAbsorbedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceAbsorbedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceAbsorbedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceAbsorbedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceAbsorbedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceAbsorbedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceAbsorbedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceAbsorbedBy doEndTag", e);
			throw new JspTagException("Exception raised in FiniteResourceAbsorbedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FiniteResourceAbsorbedByIterator");
