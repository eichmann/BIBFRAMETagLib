...
public class FiniteResourceTranslates extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceTranslates currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceTranslates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceTranslatesIterator.getTranslates());
		} catch (Exception e) {
