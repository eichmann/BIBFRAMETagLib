...
public class FiniteResourceLanguage extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceLanguage currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceLanguage.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceLanguageIterator.getLanguage());
		} catch (Exception e) {
