...
public class FiniteResourceHasOriginalVersionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceHasOriginalVersionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceHasOriginalVersionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceHasOriginalVersionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceHasOriginalVersionInverseIterator doStartTag");
		}
