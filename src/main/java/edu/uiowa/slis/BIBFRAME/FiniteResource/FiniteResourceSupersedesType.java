...
public class FiniteResourceSupersedesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceSupersedesType currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceSupersedesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceSupersedesIterator.getType());
		} catch (Exception e) {
