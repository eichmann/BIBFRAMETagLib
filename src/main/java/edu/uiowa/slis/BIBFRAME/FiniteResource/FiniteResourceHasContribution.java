...
public class FiniteResourceHasContribution extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceHasContribution currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceHasContribution.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceHasContributionIterator.getHasContribution());
		} catch (Exception e) {
