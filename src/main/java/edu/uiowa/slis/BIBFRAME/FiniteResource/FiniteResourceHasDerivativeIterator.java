...
public class FiniteResourceHasDerivativeIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceHasDerivativeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceHasDerivativeIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceHasDerivativeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceHasDerivativeIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceHasDerivativeIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceHasDerivativeIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceHasDerivative doEndTag", e);
			throw new JspTagException("Exception raised in FiniteResourceHasDerivative doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FiniteResourceHasDerivativeIterator");
