...
public class FiniteResourceSupersedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceSupersedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceSupersedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceSupersedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceSupersedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceSupersedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceSupersedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceSupersedes doEndTag", e);
			throw new JspTagException("Exception raised in FiniteResourceSupersedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FiniteResourceSupersedesIterator");
