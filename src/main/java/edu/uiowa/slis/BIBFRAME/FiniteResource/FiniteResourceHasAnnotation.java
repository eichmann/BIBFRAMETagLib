...
public class FiniteResourceHasAnnotation extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceHasAnnotation currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceHasAnnotation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceHasAnnotationIterator.getHasAnnotation());
		} catch (Exception e) {
