...
public class FiniteResourceRecordedAt extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceRecordedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceRecordedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceRecordedAtIterator.getRecordedAt());
		} catch (Exception e) {
