...
public class FiniteResourceCreatedForDegreeType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceCreatedForDegreeType currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceCreatedForDegreeType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceCreatedForDegreeIterator.getType());
		} catch (Exception e) {
