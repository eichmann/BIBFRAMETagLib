...
public class FiniteResourceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/FiniteResource> . "+
