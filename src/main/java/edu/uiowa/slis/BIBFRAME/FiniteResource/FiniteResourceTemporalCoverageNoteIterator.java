...
public class FiniteResourceTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceTemporalCoverageNoteIterator.class);
