...
public class FiniteResourceHasOtherEditionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceHasOtherEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceHasOtherEditionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceHasOtherEditionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceHasOtherEditionIterator doStartTag");
		}
