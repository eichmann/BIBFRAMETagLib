...
public class FiniteResourceHasOtherEditionInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceHasOtherEditionInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceHasOtherEditionInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceHasOtherEditionInverseIterator.getHasOtherEditionInverse());
		} catch (Exception e) {
