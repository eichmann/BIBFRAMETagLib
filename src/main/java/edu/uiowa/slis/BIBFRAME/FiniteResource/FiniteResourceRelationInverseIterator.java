...
public class FiniteResourceRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceRelationInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceRelationInverseIterator doStartTag");
		}
