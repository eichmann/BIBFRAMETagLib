...
public class FiniteResourceDerivedFromType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceDerivedFromType currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceDerivedFromType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceDerivedFromIterator.getType());
		} catch (Exception e) {
