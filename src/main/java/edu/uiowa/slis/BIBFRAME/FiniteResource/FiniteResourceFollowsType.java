...
public class FiniteResourceFollowsType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceFollowsType currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceFollowsType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFiniteResourceFollowsIterator.getType());
		} catch (Exception e) {
