...
public class FiniteResourceHasSupplementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceHasSupplementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceHasSupplementIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceHasSupplementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceHasSupplementIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceHasSupplementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceHasSupplementIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceHasSupplement doEndTag", e);
			throw new JspTagException("Exception raised in FiniteResourceHasSupplement doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FiniteResourceHasSupplementIterator");
