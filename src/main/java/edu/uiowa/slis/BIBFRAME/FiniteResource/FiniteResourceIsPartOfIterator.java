...
public class FiniteResourceIsPartOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceIsPartOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceIsPartOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceIsPartOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceIsPartOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FiniteResourceIsPartOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FiniteResourceIsPartOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FiniteResourceIsPartOf doEndTag", e);
			throw new JspTagException("Exception raised in FiniteResourceIsPartOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FiniteResourceIsPartOfIterator");
