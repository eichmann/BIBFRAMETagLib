...
public class FiniteResource extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResource currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResource.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			FiniteResourceIterator theFiniteResourceIterator = (FiniteResourceIterator) findAncestorWithClass(this, FiniteResourceIterator.class);

			if (theFiniteResourceIterator != null) {
				subjectURI = theFiniteResourceIterator.getSubjectURI();
				label = theFiniteResourceIterator.getLabel();
			}
			...
			if (theFiniteResourceIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in FiniteResource doStartTag", e);
			throw new JspTagException("Exception raised in FiniteResource doStartTag");
		} finally {
			freeConnection();
		}
