...
public class FiniteResourceNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FiniteResourceNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FiniteResourceNameIterator.class);
