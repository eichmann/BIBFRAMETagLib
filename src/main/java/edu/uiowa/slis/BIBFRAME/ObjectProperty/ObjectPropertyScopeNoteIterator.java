...
public class ObjectPropertyScopeNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ObjectPropertyScopeNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyScopeNoteIterator.class);
