...
public class TactilePreferredCitationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactilePreferredCitationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactilePreferredCitationIterator.class);
