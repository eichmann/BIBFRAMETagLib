...
public class TactileSupplementaryContentNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileSupplementaryContentNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileSupplementaryContentNoteIterator.class);
