...
public class TactileContentsNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileContentsNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileContentsNoteIterator.class);
