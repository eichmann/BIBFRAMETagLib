...
public class TactileFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileFormDesignationIterator.class);
