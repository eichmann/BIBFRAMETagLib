...
public class TactileAwardNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileAwardNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileAwardNoteIterator.class);
