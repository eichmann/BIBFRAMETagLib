...
public class TactileLanguageIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileLanguageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileLanguageIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TactileLanguageIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TactileLanguageIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TactileLanguageIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TactileLanguageIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TactileLanguage doEndTag", e);
			throw new JspTagException("Exception raised in TactileLanguage doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TactileLanguageIterator");
