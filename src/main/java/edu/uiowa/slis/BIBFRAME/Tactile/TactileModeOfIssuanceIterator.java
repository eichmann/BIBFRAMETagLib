...
public class TactileModeOfIssuanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileModeOfIssuanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileModeOfIssuanceIterator.class);
