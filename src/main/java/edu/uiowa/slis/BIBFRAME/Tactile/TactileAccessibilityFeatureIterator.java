...
public class TactileAccessibilityFeatureIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileAccessibilityFeatureIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileAccessibilityFeatureIterator.class);
