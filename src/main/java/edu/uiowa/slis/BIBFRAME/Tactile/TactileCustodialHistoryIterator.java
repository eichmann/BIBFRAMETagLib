...
public class TactileCustodialHistoryIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileCustodialHistoryIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileCustodialHistoryIterator.class);
