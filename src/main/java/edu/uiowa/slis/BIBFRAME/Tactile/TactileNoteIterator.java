...
public class TactileNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileNoteIterator.class);
