...
public class TactileReproduces extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileReproduces currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileReproduces.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTactileReproducesIterator.getReproduces());
		} catch (Exception e) {
