...
public class TactileIsInstanceOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileIsInstanceOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileIsInstanceOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in TactileIsInstanceOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TactileIsInstanceOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in TactileIsInstanceOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in TactileIsInstanceOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in TactileIsInstanceOf doEndTag", e);
			throw new JspTagException("Exception raised in TactileIsInstanceOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TactileIsInstanceOfIterator");
