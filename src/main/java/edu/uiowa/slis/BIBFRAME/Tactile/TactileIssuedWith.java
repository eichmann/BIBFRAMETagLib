...
public class TactileIssuedWith extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileIssuedWith currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileIssuedWith.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTactileIssuedWithIterator.getIssuedWith());
		} catch (Exception e) {
