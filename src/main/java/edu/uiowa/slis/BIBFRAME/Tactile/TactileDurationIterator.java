...
public class TactileDurationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileDurationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileDurationIterator.class);
