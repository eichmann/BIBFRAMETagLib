...
public class TactileCopyrightDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TactileCopyrightDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TactileCopyrightDateIterator.class);
