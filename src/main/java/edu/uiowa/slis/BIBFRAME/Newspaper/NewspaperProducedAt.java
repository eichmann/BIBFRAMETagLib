...
public class NewspaperProducedAt extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NewspaperProducedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperProducedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperProducedAtIterator.getProducedAt());
		} catch (Exception e) {
