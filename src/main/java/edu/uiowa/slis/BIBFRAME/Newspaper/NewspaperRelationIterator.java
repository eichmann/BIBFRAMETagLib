...
public class NewspaperRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NewspaperRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperRelationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NewspaperRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NewspaperRelationIterator doStartTag");
		}
