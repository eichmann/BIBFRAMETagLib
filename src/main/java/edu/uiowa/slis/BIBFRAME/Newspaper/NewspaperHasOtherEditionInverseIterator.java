...
public class NewspaperHasOtherEditionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NewspaperHasOtherEditionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperHasOtherEditionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NewspaperHasOtherEditionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NewspaperHasOtherEditionInverseIterator doStartTag");
		}
