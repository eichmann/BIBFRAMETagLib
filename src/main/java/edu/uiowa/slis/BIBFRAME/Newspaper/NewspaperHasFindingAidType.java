...
public class NewspaperHasFindingAidType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NewspaperHasFindingAidType currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperHasFindingAidType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperHasFindingAidIterator.getType());
		} catch (Exception e) {
