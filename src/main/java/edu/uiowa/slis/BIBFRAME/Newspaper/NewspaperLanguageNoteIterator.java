...
public class NewspaperLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NewspaperLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperLanguageNoteIterator.class);
