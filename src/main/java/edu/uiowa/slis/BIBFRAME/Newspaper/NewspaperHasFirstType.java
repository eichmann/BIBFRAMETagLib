...
public class NewspaperHasFirstType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NewspaperHasFirstType currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperHasFirstType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperHasFirstIterator.getType());
		} catch (Exception e) {
