...
public class NewspaperHasPart extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NewspaperHasPart currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperHasPart.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperHasPartIterator.getHasPart());
		} catch (Exception e) {
