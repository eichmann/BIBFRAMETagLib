...
public class InverseFunctionalPropertyLabelIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InverseFunctionalPropertyLabelIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InverseFunctionalPropertyLabelIterator.class);
