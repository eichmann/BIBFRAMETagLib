...
public class InverseFunctionalPropertyScopeNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static InverseFunctionalPropertyScopeNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InverseFunctionalPropertyScopeNoteIterator.class);
