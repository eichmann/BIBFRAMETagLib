...
public class PrintFormatOfMusicIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintFormatOfMusicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintFormatOfMusicIterator.class);
