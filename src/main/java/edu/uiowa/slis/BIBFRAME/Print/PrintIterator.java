...
public class PrintIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/Print> . "+
