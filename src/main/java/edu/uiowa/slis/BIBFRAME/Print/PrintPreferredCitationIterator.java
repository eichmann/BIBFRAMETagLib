...
public class PrintPreferredCitationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintPreferredCitationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintPreferredCitationIterator.class);
