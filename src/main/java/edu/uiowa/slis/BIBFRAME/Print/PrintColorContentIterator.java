...
public class PrintColorContentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintColorContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintColorContentIterator.class);
