...
public class PrintProducesSoundIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintProducesSoundIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintProducesSoundIterator.class);
