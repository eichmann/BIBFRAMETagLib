...
public class PrintCustodialHistoryIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintCustodialHistoryIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintCustodialHistoryIterator.class);
