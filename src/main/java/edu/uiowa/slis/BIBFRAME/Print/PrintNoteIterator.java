...
public class PrintNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintNoteIterator.class);
