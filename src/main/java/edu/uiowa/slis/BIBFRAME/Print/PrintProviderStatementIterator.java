...
public class PrintProviderStatementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintProviderStatementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintProviderStatementIterator.class);
