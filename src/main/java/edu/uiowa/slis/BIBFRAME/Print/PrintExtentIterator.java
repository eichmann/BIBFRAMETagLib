...
public class PrintExtentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintExtentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintExtentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://bib.ld4l.org/ontology/extent> ?s } ");
			if(rs.hasNext()) {
