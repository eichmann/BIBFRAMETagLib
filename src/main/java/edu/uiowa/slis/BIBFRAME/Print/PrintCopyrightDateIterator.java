...
public class PrintCopyrightDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintCopyrightDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintCopyrightDateIterator.class);
