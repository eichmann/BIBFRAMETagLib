...
public class PrintFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintFormDesignationIterator.class);
