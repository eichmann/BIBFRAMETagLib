...
public class PrintResponsibilityNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintResponsibilityNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintResponsibilityNoteIterator.class);
