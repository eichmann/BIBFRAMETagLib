...
public class PrintIllustrationNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PrintIllustrationNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrintIllustrationNoteIterator.class);
