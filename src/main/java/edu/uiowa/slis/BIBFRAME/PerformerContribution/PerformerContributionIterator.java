...
public class PerformerContributionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PerformerContributionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PerformerContributionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/PerformerContribution> . "+
			...
			log.error("Exception raised in PerformerContributionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PerformerContributionIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in PerformerContributionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PerformerContributionIterator doAfterBody");
		}
