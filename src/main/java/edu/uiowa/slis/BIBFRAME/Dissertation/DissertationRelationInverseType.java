...
public class DissertationRelationInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DissertationRelationInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(DissertationRelationInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDissertationRelationInverseIterator.getType());
		} catch (Exception e) {
