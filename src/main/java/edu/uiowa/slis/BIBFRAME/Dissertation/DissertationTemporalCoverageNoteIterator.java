...
public class DissertationTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DissertationTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DissertationTemporalCoverageNoteIterator.class);
