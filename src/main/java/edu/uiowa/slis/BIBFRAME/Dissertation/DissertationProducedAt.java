...
public class DissertationProducedAt extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DissertationProducedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(DissertationProducedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDissertationProducedAtIterator.getProducedAt());
		} catch (Exception e) {
