...
public class DissertationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DissertationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DissertationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/Dissertation> . "+
