...
public class CirculationStatusSemanticRelationInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CirculationStatusSemanticRelationInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CirculationStatusSemanticRelationInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCirculationStatusSemanticRelationInverseIterator.getType());
		} catch (Exception e) {
