...
public class CirculationStatusMemberInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static CirculationStatusMemberInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(CirculationStatusMemberInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCirculationStatusMemberInverseIterator.getMemberInverse());
		} catch (Exception e) {
