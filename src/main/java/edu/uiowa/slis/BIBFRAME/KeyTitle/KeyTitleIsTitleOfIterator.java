...
public class KeyTitleIsTitleOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static KeyTitleIsTitleOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KeyTitleIsTitleOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in KeyTitleIsTitleOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KeyTitleIsTitleOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in KeyTitleIsTitleOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KeyTitleIsTitleOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in KeyTitleIsTitleOf doEndTag", e);
			throw new JspTagException("Exception raised in KeyTitleIsTitleOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to KeyTitleIsTitleOfIterator");
