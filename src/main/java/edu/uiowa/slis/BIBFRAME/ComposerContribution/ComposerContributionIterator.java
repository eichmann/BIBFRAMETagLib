...
public class ComposerContributionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ComposerContributionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ComposerContributionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/ComposerContribution> . "+
			...
			log.error("Exception raised in ComposerContributionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ComposerContributionIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in ComposerContributionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ComposerContributionIterator doAfterBody");
		}
