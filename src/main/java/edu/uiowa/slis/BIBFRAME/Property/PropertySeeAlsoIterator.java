...
public class PropertySeeAlsoIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PropertySeeAlsoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PropertySeeAlsoIterator.class);
