...
public class PropertyNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PropertyNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PropertyNoteIterator.class);
