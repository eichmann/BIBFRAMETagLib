...
public class PropertyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PropertyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.w3.org/1999/02/22-rdf-syntax-ns#Property> . "+
