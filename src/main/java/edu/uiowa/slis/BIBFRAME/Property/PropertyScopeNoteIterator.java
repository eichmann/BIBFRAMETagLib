...
public class PropertyScopeNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PropertyScopeNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PropertyScopeNoteIterator.class);
