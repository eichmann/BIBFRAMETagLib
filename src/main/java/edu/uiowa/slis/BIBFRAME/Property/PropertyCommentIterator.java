...
public class PropertyCommentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PropertyCommentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PropertyCommentIterator.class);
