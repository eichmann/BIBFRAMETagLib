...
public class PropertyLabelIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PropertyLabelIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PropertyLabelIterator.class);
