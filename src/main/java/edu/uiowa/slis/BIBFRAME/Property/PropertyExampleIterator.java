...
public class PropertyExampleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PropertyExampleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PropertyExampleIterator.class);
