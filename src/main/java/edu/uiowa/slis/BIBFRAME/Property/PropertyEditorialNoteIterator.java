...
public class PropertyEditorialNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PropertyEditorialNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PropertyEditorialNoteIterator.class);
