...
public class StillImageHasTitleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageHasTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageHasTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageHasTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in StillImageHasTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StillImageHasTitle doEndTag", e);
			throw new JspTagException("Exception raised in StillImageHasTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to StillImageHasTitleIterator");
