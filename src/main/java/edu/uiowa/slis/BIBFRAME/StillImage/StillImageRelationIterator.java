...
public class StillImageRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageRelationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageRelationIterator doStartTag");
		}
