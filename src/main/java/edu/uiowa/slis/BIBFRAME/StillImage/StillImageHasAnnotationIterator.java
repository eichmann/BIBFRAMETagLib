...
public class StillImageHasAnnotationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageHasAnnotationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageHasAnnotationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageHasAnnotationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasAnnotationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in StillImageHasAnnotationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasAnnotationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StillImageHasAnnotation doEndTag", e);
			throw new JspTagException("Exception raised in StillImageHasAnnotation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to StillImageHasAnnotationIterator");
