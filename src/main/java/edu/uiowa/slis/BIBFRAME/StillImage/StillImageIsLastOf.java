...
public class StillImageIsLastOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageIsLastOf currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageIsLastOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStillImageIsLastOfIterator.getIsLastOf());
		} catch (Exception e) {
