...
public class StillImageHasAbsorbedIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageHasAbsorbedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageHasAbsorbedIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageHasAbsorbedIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasAbsorbedIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in StillImageHasAbsorbedIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasAbsorbedIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StillImageHasAbsorbed doEndTag", e);
			throw new JspTagException("Exception raised in StillImageHasAbsorbed doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to StillImageHasAbsorbedIterator");
