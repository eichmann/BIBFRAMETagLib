...
public class StillImageHasOtherEditionType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageHasOtherEditionType currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageHasOtherEditionType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStillImageHasOtherEditionIterator.getType());
		} catch (Exception e) {
