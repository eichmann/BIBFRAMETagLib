...
public class StillImagePrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImagePrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImagePrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImagePrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImagePrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in StillImagePrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImagePrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StillImagePrecedes doEndTag", e);
			throw new JspTagException("Exception raised in StillImagePrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to StillImagePrecedesIterator");
