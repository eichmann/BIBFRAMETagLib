...
public class StillImageTranslatesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageTranslatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageTranslatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageTranslatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageTranslatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in StillImageTranslatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageTranslatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StillImageTranslates doEndTag", e);
			throw new JspTagException("Exception raised in StillImageTranslates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to StillImageTranslatesIterator");
