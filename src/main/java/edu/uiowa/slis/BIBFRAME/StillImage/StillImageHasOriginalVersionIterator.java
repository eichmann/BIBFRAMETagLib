...
public class StillImageHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageHasOriginalVersionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasOriginalVersionIterator doStartTag");
		}
