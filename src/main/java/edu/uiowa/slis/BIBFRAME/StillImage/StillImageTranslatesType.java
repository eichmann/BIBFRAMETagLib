...
public class StillImageTranslatesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageTranslatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageTranslatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStillImageTranslatesIterator.getType());
		} catch (Exception e) {
