...
public class StillImageHasContributionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageHasContributionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageHasContributionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageHasContributionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasContributionIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in StillImageHasContributionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageHasContributionIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StillImageHasContribution doEndTag", e);
			throw new JspTagException("Exception raised in StillImageHasContribution doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to StillImageHasContributionIterator");
