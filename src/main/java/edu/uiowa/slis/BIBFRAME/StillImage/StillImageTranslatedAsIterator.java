...
public class StillImageTranslatedAsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageTranslatedAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageTranslatedAsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageTranslatedAsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageTranslatedAsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in StillImageTranslatedAsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageTranslatedAsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StillImageTranslatedAs doEndTag", e);
			throw new JspTagException("Exception raised in StillImageTranslatedAs doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to StillImageTranslatedAsIterator");
