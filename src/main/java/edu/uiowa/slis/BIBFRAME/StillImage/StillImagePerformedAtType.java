...
public class StillImagePerformedAtType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImagePerformedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImagePerformedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStillImagePerformedAtIterator.getType());
		} catch (Exception e) {
