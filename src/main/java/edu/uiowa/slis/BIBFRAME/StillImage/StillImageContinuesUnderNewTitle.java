...
public class StillImageContinuesUnderNewTitle extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageContinuesUnderNewTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageContinuesUnderNewTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStillImageContinuesUnderNewTitleIterator.getContinuesUnderNewTitle());
		} catch (Exception e) {
