...
public class StillImageAgentInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static StillImageAgentInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StillImageAgentInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in StillImageAgentInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageAgentInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in StillImageAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StillImageAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StillImageAgent doEndTag", e);
			throw new JspTagException("Exception raised in StillImageAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to StillImageAgentIterator");
