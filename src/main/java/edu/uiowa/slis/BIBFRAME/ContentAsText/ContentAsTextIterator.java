...
public class ContentAsTextIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContentAsTextIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContentAsTextIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://www.w3.org/2011/content#ContentAsText> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
