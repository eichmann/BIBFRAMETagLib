...
public class ClassificationMemberInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ClassificationMemberInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassificationMemberInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClassificationMemberInverseIterator.getMemberInverse());
		} catch (Exception e) {
