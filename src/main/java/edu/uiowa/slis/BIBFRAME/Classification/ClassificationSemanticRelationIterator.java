...
public class ClassificationSemanticRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ClassificationSemanticRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassificationSemanticRelationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ClassificationSemanticRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ClassificationSemanticRelationIterator doStartTag");
		}
