...
public class MultimediaIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/Multimedia> . "+
