...
public class MultimediaHasAbsorbedIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaHasAbsorbedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaHasAbsorbedIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MultimediaHasAbsorbedIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaHasAbsorbedIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MultimediaHasAbsorbedIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaHasAbsorbedIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MultimediaHasAbsorbed doEndTag", e);
			throw new JspTagException("Exception raised in MultimediaHasAbsorbed doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MultimediaHasAbsorbedIterator");
