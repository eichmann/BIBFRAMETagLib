...
public class MultimediaHasAnnotationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaHasAnnotationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaHasAnnotationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MultimediaHasAnnotationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaHasAnnotationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MultimediaHasAnnotationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaHasAnnotationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MultimediaHasAnnotation doEndTag", e);
			throw new JspTagException("Exception raised in MultimediaHasAnnotation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MultimediaHasAnnotationIterator");
