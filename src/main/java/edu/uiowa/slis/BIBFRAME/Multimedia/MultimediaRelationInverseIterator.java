...
public class MultimediaRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MultimediaRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaRelationInverseIterator doStartTag");
		}
