...
public class MultimediaHasInstanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaHasInstanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaHasInstanceIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MultimediaHasInstanceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaHasInstanceIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MultimediaHasInstanceIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaHasInstanceIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MultimediaHasInstance doEndTag", e);
			throw new JspTagException("Exception raised in MultimediaHasInstance doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MultimediaHasInstanceIterator");
