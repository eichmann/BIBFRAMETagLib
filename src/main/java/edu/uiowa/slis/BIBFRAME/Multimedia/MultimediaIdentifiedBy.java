...
public class MultimediaIdentifiedBy extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaIdentifiedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaIdentifiedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultimediaIdentifiedByIterator.getIdentifiedBy());
		} catch (Exception e) {
