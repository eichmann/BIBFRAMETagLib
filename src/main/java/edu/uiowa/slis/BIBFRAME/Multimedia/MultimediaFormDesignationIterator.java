...
public class MultimediaFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaFormDesignationIterator.class);
