...
public class MultimediaDerivedFromIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaDerivedFromIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaDerivedFromIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MultimediaDerivedFromIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaDerivedFromIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MultimediaDerivedFromIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaDerivedFromIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MultimediaDerivedFrom doEndTag", e);
			throw new JspTagException("Exception raised in MultimediaDerivedFrom doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MultimediaDerivedFromIterator");
