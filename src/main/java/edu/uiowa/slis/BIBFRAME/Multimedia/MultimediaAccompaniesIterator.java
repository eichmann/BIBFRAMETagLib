...
public class MultimediaAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaAccompaniesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaAccompaniesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MultimediaAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MultimediaAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MultimediaAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in MultimediaAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MultimediaAccompaniesIterator");
