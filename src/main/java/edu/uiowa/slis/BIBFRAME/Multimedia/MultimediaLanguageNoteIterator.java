...
public class MultimediaLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaLanguageNoteIterator.class);
