...
public class MultimediaHasTitle extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaHasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaHasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultimediaHasTitleIterator.getHasTitle());
		} catch (Exception e) {
