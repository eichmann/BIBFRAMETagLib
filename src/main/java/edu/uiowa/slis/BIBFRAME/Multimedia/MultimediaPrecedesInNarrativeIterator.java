...
public class MultimediaPrecedesInNarrativeIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaPrecedesInNarrativeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaPrecedesInNarrativeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MultimediaPrecedesInNarrativeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaPrecedesInNarrativeIterator doStartTag");
		}
