...
public class MultimediaAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MultimediaAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MultimediaAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MultimediaAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in MultimediaAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MultimediaAccompaniedByIterator");
