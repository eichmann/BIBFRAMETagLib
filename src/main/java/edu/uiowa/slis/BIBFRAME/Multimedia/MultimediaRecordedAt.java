...
public class MultimediaRecordedAt extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaRecordedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaRecordedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultimediaRecordedAtIterator.getRecordedAt());
		} catch (Exception e) {
