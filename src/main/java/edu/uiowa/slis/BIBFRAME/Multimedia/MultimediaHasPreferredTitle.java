...
public class MultimediaHasPreferredTitle extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaHasPreferredTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaHasPreferredTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultimediaHasPreferredTitleIterator.getHasPreferredTitle());
		} catch (Exception e) {
