...
public class MultimediaHasOriginalVersion extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaHasOriginalVersion currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaHasOriginalVersion.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultimediaHasOriginalVersionIterator.getHasOriginalVersion());
		} catch (Exception e) {
