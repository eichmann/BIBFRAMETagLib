...
public class MultimediaIsFirstOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaIsFirstOf currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaIsFirstOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultimediaIsFirstOfIterator.getIsFirstOf());
		} catch (Exception e) {
