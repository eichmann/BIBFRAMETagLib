...
public class MultimediaHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultimediaHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultimediaHasOriginalVersionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MultimediaHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MultimediaHasOriginalVersionIterator doStartTag");
		}
