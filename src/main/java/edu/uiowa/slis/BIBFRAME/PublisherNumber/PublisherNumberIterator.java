...
public class PublisherNumberIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PublisherNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNumberIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/PublisherNumber> . "+
			...
			log.error("Exception raised in PublisherNumberIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PublisherNumberIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in PublisherNumberIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PublisherNumberIterator doAfterBody");
		}
