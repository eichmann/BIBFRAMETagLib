...
public class PeriodicalPartRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartRelationInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PeriodicalPartRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalPartRelationInverseIterator doStartTag");
		}
