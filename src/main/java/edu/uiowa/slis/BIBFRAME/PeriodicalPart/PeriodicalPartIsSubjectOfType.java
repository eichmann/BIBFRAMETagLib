...
public class PeriodicalPartIsSubjectOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartIsSubjectOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartIsSubjectOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPartIsSubjectOfIterator.getType());
		} catch (Exception e) {
