...
public class PeriodicalPartHasOriginalVersionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartHasOriginalVersionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartHasOriginalVersionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PeriodicalPartHasOriginalVersionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalPartHasOriginalVersionIterator doStartTag");
		}
