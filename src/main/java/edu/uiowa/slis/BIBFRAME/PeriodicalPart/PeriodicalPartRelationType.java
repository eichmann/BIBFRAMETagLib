...
public class PeriodicalPartRelationType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartRelationType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartRelationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPartRelationIterator.getType());
		} catch (Exception e) {
