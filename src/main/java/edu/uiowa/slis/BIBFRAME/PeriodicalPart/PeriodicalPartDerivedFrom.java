...
public class PeriodicalPartDerivedFrom extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartDerivedFrom currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartDerivedFrom.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPartDerivedFromIterator.getDerivedFrom());
		} catch (Exception e) {
