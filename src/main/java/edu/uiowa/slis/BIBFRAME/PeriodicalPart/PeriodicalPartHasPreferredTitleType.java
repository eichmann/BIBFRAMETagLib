...
public class PeriodicalPartHasPreferredTitleType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartHasPreferredTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartHasPreferredTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPartHasPreferredTitleIterator.getType());
		} catch (Exception e) {
