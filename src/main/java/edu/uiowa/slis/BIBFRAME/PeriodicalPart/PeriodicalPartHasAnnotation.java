...
public class PeriodicalPartHasAnnotation extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartHasAnnotation currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartHasAnnotation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPartHasAnnotationIterator.getHasAnnotation());
		} catch (Exception e) {
