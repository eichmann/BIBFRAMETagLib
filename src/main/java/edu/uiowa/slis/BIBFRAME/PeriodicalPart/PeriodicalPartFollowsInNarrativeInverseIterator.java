...
public class PeriodicalPartFollowsInNarrativeInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartFollowsInNarrativeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartFollowsInNarrativeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PeriodicalPartFollowsInNarrativeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalPartFollowsInNarrativeInverseIterator doStartTag");
		}
