...
public class PeriodicalPartSubject extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartSubject currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartSubject.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPartSubjectIterator.getSubject());
		} catch (Exception e) {
