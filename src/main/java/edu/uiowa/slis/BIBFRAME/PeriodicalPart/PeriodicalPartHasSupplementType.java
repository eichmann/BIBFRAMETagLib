...
public class PeriodicalPartHasSupplementType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartHasSupplementType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartHasSupplementType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPartHasSupplementIterator.getType());
		} catch (Exception e) {
