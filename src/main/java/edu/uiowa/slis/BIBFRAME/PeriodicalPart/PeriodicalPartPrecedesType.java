...
public class PeriodicalPartPrecedesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPartPrecedesType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPartPrecedesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPartPrecedesIterator.getType());
		} catch (Exception e) {
