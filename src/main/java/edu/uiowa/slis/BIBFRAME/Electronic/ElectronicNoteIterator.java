...
public class ElectronicNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicNoteIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://bib.ld4l.org/ontology/note> ?s } ");
			if(rs.hasNext()) {
