...
public class ElectronicProducesSoundIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicProducesSoundIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicProducesSoundIterator.class);
