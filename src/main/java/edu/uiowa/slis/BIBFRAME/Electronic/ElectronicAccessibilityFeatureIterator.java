...
public class ElectronicAccessibilityFeatureIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicAccessibilityFeatureIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicAccessibilityFeatureIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://schema.org/accessibilityFeature> ?s } ");
			if(rs.hasNext()) {
