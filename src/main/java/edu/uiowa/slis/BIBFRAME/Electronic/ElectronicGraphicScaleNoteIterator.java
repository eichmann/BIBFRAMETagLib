...
public class ElectronicGraphicScaleNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicGraphicScaleNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicGraphicScaleNoteIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://bib.ld4l.org/ontology/legacy/graphicScaleNote> ?s } ");
			if(rs.hasNext()) {
