...
public class ElectronicHasAnnotation extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicHasAnnotation currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicHasAnnotation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theElectronicHasAnnotationIterator.getHasAnnotation());
		} catch (Exception e) {
