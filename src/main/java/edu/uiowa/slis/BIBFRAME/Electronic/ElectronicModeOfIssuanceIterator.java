...
public class ElectronicModeOfIssuanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicModeOfIssuanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicModeOfIssuanceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://bib.ld4l.org/ontology/legacy/modeOfIssuance> ?s } ");
			if(rs.hasNext()) {
