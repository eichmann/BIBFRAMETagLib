...
public class ElectronicSupplementaryContentNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicSupplementaryContentNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicSupplementaryContentNoteIterator.class);
