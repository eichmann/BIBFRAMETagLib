...
public class ElectronicAwardNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicAwardNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicAwardNoteIterator.class);
