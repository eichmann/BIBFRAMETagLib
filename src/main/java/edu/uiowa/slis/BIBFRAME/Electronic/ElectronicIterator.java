...
public class ElectronicIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://bib.ld4l.org/ontology/Electronic> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
