...
public class ElectronicIssuedWithIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicIssuedWithIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicIssuedWithIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ElectronicIssuedWithIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ElectronicIssuedWithIterator doStartTag");
		}
