...
public class ElectronicCopyrightDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicCopyrightDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicCopyrightDateIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://bib.ld4l.org/ontology/copyrightDate> ?s } ");
			if(rs.hasNext()) {
