...
public class ElectronicHasHolding extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicHasHolding currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicHasHolding.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theElectronicHasHoldingIterator.getHasHolding());
		} catch (Exception e) {
