...
public class ElectronicCustodialHistoryIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicCustodialHistoryIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicCustodialHistoryIterator.class);

	String subjectURI = null;
	String custodialHistory = null;
	ResultSet rs = null;
