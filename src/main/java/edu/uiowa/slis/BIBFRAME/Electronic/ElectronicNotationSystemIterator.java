...
public class ElectronicNotationSystemIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicNotationSystemIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicNotationSystemIterator.class);
