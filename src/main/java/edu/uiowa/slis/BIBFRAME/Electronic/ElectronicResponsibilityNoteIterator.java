...
public class ElectronicResponsibilityNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ElectronicResponsibilityNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ElectronicResponsibilityNoteIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://bib.ld4l.org/ontology/responsibilityNote> ?s } ");
			if(rs.hasNext()) {
