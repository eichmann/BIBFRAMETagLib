...
public class NotatedMusicFrequencyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMusicFrequencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMusicFrequencyIterator.class);
