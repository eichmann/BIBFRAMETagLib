...
public class NotatedMusicRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMusicRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMusicRelationInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NotatedMusicRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMusicRelationInverseIterator doStartTag");
		}
