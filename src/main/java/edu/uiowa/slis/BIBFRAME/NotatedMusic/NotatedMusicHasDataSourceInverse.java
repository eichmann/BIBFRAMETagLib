...
public class NotatedMusicHasDataSourceInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMusicHasDataSourceInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMusicHasDataSourceInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNotatedMusicHasDataSourceInverseIterator.getHasDataSourceInverse());
		} catch (Exception e) {
