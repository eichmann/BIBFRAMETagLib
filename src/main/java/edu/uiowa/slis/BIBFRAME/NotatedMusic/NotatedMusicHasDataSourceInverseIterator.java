...
public class NotatedMusicHasDataSourceInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMusicHasDataSourceInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMusicHasDataSourceInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NotatedMusicHasDataSourceInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMusicHasDataSourceInverseIterator doStartTag");
		}
