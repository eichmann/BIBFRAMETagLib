...
public class NotatedMusicIsLastOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMusicIsLastOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMusicIsLastOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNotatedMusicIsLastOfIterator.getType());
		} catch (Exception e) {
