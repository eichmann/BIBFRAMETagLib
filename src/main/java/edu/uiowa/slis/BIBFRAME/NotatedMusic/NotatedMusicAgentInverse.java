...
public class NotatedMusicAgentInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMusicAgentInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMusicAgentInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNotatedMusicAgentInverseIterator.getAgentInverse());
		} catch (Exception e) {
