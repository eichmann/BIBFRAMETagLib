...
public class NotatedMusicIsSubjectOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMusicIsSubjectOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMusicIsSubjectOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in NotatedMusicIsSubjectOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMusicIsSubjectOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in NotatedMusicIsSubjectOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NotatedMusicIsSubjectOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NotatedMusicIsSubjectOf doEndTag", e);
			throw new JspTagException("Exception raised in NotatedMusicIsSubjectOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to NotatedMusicIsSubjectOfIterator");
