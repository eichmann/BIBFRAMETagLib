...
public class NotatedMusicIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NotatedMusicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotatedMusicIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/NotatedMusic> . "+
