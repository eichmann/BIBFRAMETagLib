...
public class OntologyIssuedIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static OntologyIssuedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OntologyIssuedIterator.class);
