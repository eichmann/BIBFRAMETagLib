...
public class OntologyPreferredNamespacePrefixIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static OntologyPreferredNamespacePrefixIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OntologyPreferredNamespacePrefixIterator.class);
