...
public class MonographHasOriginalVersionType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographHasOriginalVersionType currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographHasOriginalVersionType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMonographHasOriginalVersionIterator.getType());
		} catch (Exception e) {
