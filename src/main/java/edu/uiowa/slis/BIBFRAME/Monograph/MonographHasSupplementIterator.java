...
public class MonographHasSupplementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographHasSupplementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographHasSupplementIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MonographHasSupplementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MonographHasSupplementIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MonographHasSupplementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MonographHasSupplementIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MonographHasSupplement doEndTag", e);
			throw new JspTagException("Exception raised in MonographHasSupplement doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MonographHasSupplementIterator");
