...
public class MonographAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MonographAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MonographAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MonographAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MonographAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MonographAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in MonographAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MonographAccompaniedByIterator");
