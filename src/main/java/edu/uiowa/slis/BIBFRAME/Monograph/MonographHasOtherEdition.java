...
public class MonographHasOtherEdition extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographHasOtherEdition currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographHasOtherEdition.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMonographHasOtherEditionIterator.getHasOtherEdition());
		} catch (Exception e) {
