...
public class MonographPrecedesInNarrativeInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographPrecedesInNarrativeInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographPrecedesInNarrativeInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMonographPrecedesInNarrativeInverseIterator.getPrecedesInNarrativeInverse());
		} catch (Exception e) {
