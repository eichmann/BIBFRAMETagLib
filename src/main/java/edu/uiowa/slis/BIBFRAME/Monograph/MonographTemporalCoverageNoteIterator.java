...
public class MonographTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographTemporalCoverageNoteIterator.class);
