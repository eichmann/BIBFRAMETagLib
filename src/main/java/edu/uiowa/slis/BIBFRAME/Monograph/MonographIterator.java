...
public class MonographIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/Monograph> . "+
