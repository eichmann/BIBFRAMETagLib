...
public class MonographAccompanies extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographAccompanies currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographAccompanies.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMonographAccompaniesIterator.getAccompanies());
		} catch (Exception e) {
