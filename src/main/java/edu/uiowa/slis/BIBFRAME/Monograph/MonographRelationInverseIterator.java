...
public class MonographRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MonographRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MonographRelationInverseIterator doStartTag");
		}
