...
public class MonographHasDerivativeType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographHasDerivativeType currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographHasDerivativeType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMonographHasDerivativeIterator.getType());
		} catch (Exception e) {
