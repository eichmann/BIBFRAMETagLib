...
public class MonographHasDataSourceInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographHasDataSourceInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographHasDataSourceInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMonographHasDataSourceInverseIterator.getType());
		} catch (Exception e) {
