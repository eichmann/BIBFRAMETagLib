...
public class MonographHasContributionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MonographHasContributionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MonographHasContributionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MonographHasContributionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MonographHasContributionIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MonographHasContributionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MonographHasContributionIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MonographHasContribution doEndTag", e);
			throw new JspTagException("Exception raised in MonographHasContribution doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MonographHasContributionIterator");
