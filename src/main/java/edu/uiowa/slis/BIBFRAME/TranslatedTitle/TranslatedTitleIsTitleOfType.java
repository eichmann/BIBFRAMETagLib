...
public class TranslatedTitleIsTitleOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TranslatedTitleIsTitleOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslatedTitleIsTitleOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTranslatedTitleIsTitleOfIterator.getType());
		} catch (Exception e) {
