...
public class PolicyHasReproductionPolicyInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PolicyHasReproductionPolicyInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(PolicyHasReproductionPolicyInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePolicyHasReproductionPolicyInverseIterator.getType());
		} catch (Exception e) {
