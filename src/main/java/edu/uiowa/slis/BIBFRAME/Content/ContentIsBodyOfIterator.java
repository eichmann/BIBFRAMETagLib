...
public class ContentIsBodyOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContentIsBodyOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContentIsBodyOfIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (theContent != null) {
				subjectURI = theContent.getSubjectURI();
			}

			if (theContent == null && subjectURI == null) {
...
//					continue;
			...
			log.error("Exception raised in ContentIsBodyOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContentIsBodyOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ContentIsBodyOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContentIsBodyOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ContentIsBodyOf doEndTag", e);
			throw new JspTagException("Exception raised in ContentIsBodyOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ContentIsBodyOfIterator");
