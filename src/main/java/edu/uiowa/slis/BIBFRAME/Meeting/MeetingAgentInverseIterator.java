...
public class MeetingAgentInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingAgentInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingAgentInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MeetingAgentInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingAgentInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MeetingAgentIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingAgentIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MeetingAgent doEndTag", e);
			throw new JspTagException("Exception raised in MeetingAgent doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MeetingAgentIterator");
