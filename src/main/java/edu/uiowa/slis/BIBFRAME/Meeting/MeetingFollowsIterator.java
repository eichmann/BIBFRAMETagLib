...
public class MeetingFollowsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingFollowsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingFollowsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MeetingFollowsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingFollowsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MeetingFollowsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingFollowsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MeetingFollows doEndTag", e);
			throw new JspTagException("Exception raised in MeetingFollows doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MeetingFollowsIterator");
