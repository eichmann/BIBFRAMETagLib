...
public class MeetingIsSubjectOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingIsSubjectOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingIsSubjectOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MeetingIsSubjectOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingIsSubjectOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MeetingIsSubjectOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingIsSubjectOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MeetingIsSubjectOf doEndTag", e);
			throw new JspTagException("Exception raised in MeetingIsSubjectOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MeetingIsSubjectOfIterator");
