...
public class MeetingHasPartIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingHasPartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingHasPartIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MeetingHasPartIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingHasPartIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MeetingHasPartIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingHasPartIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MeetingHasPart doEndTag", e);
			throw new JspTagException("Exception raised in MeetingHasPart doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MeetingHasPartIterator");
