...
public class MeetingIsPartOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingIsPartOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingIsPartOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MeetingIsPartOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingIsPartOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MeetingIsPartOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingIsPartOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MeetingIsPartOf doEndTag", e);
			throw new JspTagException("Exception raised in MeetingIsPartOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MeetingIsPartOfIterator");
