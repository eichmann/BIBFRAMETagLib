...
public class MeetingLanguageIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingLanguageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingLanguageIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MeetingLanguageIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingLanguageIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MeetingLanguageIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingLanguageIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MeetingLanguage doEndTag", e);
			throw new JspTagException("Exception raised in MeetingLanguage doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MeetingLanguageIterator");
