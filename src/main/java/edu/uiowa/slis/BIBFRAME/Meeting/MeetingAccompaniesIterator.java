...
public class MeetingAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingAccompaniesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingAccompaniesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MeetingAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MeetingAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MeetingAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in MeetingAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MeetingAccompaniesIterator");
