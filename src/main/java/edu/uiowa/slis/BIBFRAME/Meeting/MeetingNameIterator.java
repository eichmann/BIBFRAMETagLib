...
public class MeetingNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingNameIterator.class);
