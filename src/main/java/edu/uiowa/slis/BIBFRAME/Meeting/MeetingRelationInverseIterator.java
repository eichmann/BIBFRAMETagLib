...
public class MeetingRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MeetingRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MeetingRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MeetingRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MeetingRelation doEndTag", e);
			throw new JspTagException("Exception raised in MeetingRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MeetingRelationIterator");
