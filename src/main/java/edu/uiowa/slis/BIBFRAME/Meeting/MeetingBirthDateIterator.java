...
public class MeetingBirthDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MeetingBirthDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingBirthDateIterator.class);
