...
public class FamilyNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FamilyNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FamilyNameIterator.class);
