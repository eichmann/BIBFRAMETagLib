...
public class FamilyIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FamilyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FamilyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/Family> . "+
