...
public class FamilyIdentifiedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FamilyIdentifiedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FamilyIdentifiedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FamilyIdentifiedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FamilyIdentifiedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FamilyIdentifiedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FamilyIdentifiedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FamilyIdentifiedBy doEndTag", e);
			throw new JspTagException("Exception raised in FamilyIdentifiedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FamilyIdentifiedByIterator");
