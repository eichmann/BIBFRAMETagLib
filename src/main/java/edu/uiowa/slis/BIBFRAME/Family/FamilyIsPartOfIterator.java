...
public class FamilyIsPartOfIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FamilyIsPartOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FamilyIsPartOfIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FamilyIsPartOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FamilyIsPartOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FamilyIsPartOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FamilyIsPartOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FamilyIsPartOf doEndTag", e);
			throw new JspTagException("Exception raised in FamilyIsPartOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FamilyIsPartOfIterator");
