...
public class MovingImageIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/MovingImage> . "+
