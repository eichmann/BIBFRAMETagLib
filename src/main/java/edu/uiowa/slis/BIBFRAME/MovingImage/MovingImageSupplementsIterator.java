...
public class MovingImageSupplementsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageSupplementsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageSupplementsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MovingImageSupplementsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageSupplementsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MovingImageSupplementsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageSupplementsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MovingImageSupplements doEndTag", e);
			throw new JspTagException("Exception raised in MovingImageSupplements doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MovingImageSupplementsIterator");
