...
public class MovingImageHasOtherEditionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageHasOtherEditionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageHasOtherEditionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MovingImageHasOtherEditionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasOtherEditionInverseIterator doStartTag");
		}
