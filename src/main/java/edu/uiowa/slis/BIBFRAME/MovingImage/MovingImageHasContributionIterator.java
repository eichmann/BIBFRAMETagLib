...
public class MovingImageHasContributionIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageHasContributionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageHasContributionIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MovingImageHasContributionIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasContributionIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MovingImageHasContributionIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasContributionIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MovingImageHasContribution doEndTag", e);
			throw new JspTagException("Exception raised in MovingImageHasContribution doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MovingImageHasContributionIterator");
