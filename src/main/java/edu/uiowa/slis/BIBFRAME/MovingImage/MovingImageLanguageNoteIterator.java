...
public class MovingImageLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageLanguageNoteIterator.class);
