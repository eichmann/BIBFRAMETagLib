...
public class MovingImageIsExpressionOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageIsExpressionOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageIsExpressionOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMovingImageIsExpressionOfIterator.getType());
		} catch (Exception e) {
