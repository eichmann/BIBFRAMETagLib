...
public class MovingImageTranslatedAsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageTranslatedAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageTranslatedAsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MovingImageTranslatedAsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageTranslatedAsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MovingImageTranslatedAsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageTranslatedAsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MovingImageTranslatedAs doEndTag", e);
			throw new JspTagException("Exception raised in MovingImageTranslatedAs doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MovingImageTranslatedAsIterator");
