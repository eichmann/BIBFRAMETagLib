...
public class MovingImageAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MovingImageAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MovingImageAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MovingImageAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in MovingImageAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MovingImageAccompaniedByIterator");
