...
public class MovingImageHasOriginalVersion extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageHasOriginalVersion currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageHasOriginalVersion.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMovingImageHasOriginalVersionIterator.getHasOriginalVersion());
		} catch (Exception e) {
