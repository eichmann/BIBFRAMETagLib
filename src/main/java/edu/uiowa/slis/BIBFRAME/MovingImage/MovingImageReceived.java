...
public class MovingImageReceived extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageReceived currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageReceived.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMovingImageReceivedIterator.getReceived());
		} catch (Exception e) {
