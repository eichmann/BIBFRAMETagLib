...
public class MovingImageTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageTemporalCoverageNoteIterator.class);
