...
public class MovingImageHasSupplementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageHasSupplementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageHasSupplementIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MovingImageHasSupplementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasSupplementIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MovingImageHasSupplementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasSupplementIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MovingImageHasSupplement doEndTag", e);
			throw new JspTagException("Exception raised in MovingImageHasSupplement doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MovingImageHasSupplementIterator");
