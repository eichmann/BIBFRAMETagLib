...
public class MovingImageHasInstanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageHasInstanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageHasInstanceIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MovingImageHasInstanceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasInstanceIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MovingImageHasInstanceIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasInstanceIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MovingImageHasInstance doEndTag", e);
			throw new JspTagException("Exception raised in MovingImageHasInstance doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MovingImageHasInstanceIterator");
