...
public class MovingImageFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageFormDesignationIterator.class);
