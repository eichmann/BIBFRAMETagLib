...
public class MovingImageProducedAt extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageProducedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageProducedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMovingImageProducedAtIterator.getProducedAt());
		} catch (Exception e) {
