...
public class MovingImageHasAnnotationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageHasAnnotationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageHasAnnotationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in MovingImageHasAnnotationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasAnnotationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in MovingImageHasAnnotationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MovingImageHasAnnotationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MovingImageHasAnnotation doEndTag", e);
			throw new JspTagException("Exception raised in MovingImageHasAnnotation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to MovingImageHasAnnotationIterator");
