...
public class MovingImageIsUnionOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MovingImageIsUnionOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(MovingImageIsUnionOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMovingImageIsUnionOfIterator.getType());
		} catch (Exception e) {
