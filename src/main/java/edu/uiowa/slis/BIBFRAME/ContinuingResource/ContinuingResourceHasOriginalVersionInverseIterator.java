...
public class ContinuingResourceHasOriginalVersionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceHasOriginalVersionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceHasOriginalVersionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ContinuingResourceHasOriginalVersionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourceHasOriginalVersionInverseIterator doStartTag");
		}
