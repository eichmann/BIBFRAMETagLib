...
public class ContinuingResource extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResource currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResource.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			ContinuingResourceIterator theContinuingResourceIterator = (ContinuingResourceIterator) findAncestorWithClass(this, ContinuingResourceIterator.class);

			if (theContinuingResourceIterator != null) {
				subjectURI = theContinuingResourceIterator.getSubjectURI();
				label = theContinuingResourceIterator.getLabel();
			}
			...
			if (theContinuingResourceIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in ContinuingResource doStartTag", e);
			throw new JspTagException("Exception raised in ContinuingResource doStartTag");
		} finally {
			freeConnection();
		}
