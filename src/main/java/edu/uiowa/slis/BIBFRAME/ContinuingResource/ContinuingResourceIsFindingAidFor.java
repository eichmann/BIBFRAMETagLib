...
public class ContinuingResourceIsFindingAidFor extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceIsFindingAidFor currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceIsFindingAidFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinuingResourceIsFindingAidForIterator.getIsFindingAidFor());
		} catch (Exception e) {
