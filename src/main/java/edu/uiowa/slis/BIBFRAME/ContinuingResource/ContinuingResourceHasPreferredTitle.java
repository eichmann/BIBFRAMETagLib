...
public class ContinuingResourceHasPreferredTitle extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceHasPreferredTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceHasPreferredTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinuingResourceHasPreferredTitleIterator.getHasPreferredTitle());
		} catch (Exception e) {
