...
public class ContinuingResourcePrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourcePrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourcePrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourcePrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourcePrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourcePrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourcePrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ContinuingResourcePrecedes doEndTag", e);
			throw new JspTagException("Exception raised in ContinuingResourcePrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ContinuingResourcePrecedesIterator");
