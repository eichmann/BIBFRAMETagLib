...
public class ContinuingResourceSupersedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceSupersedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceSupersedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourceSupersedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourceSupersedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourceSupersedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourceSupersedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ContinuingResourceSupersedes doEndTag", e);
			throw new JspTagException("Exception raised in ContinuingResourceSupersedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ContinuingResourceSupersedesIterator");
