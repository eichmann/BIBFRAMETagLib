...
public class ContinuingResourceAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourceAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourceAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourceAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourceAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ContinuingResourceAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in ContinuingResourceAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ContinuingResourceAccompaniedByIterator");
