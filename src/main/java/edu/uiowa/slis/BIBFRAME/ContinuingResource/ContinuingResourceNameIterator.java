...
public class ContinuingResourceNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceNameIterator.class);
