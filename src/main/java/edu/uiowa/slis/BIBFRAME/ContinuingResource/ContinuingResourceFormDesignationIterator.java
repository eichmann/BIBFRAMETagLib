...
public class ContinuingResourceFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceFormDesignationIterator.class);
