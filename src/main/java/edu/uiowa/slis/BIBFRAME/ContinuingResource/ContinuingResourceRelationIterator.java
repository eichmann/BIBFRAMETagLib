...
public class ContinuingResourceRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceRelationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourceRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourceRelationIterator doStartTag");
		}
