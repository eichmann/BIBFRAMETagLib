...
public class ContinuingResourceHasTitleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceHasTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceHasTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourceHasTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourceHasTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ContinuingResourceHasTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ContinuingResourceHasTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ContinuingResourceHasTitle doEndTag", e);
			throw new JspTagException("Exception raised in ContinuingResourceHasTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ContinuingResourceHasTitleIterator");
