...
public class ContinuingResourceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/ContinuingResource> . "+
