...
public class ContinuingResourceHasOriginalVersionInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceHasOriginalVersionInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceHasOriginalVersionInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinuingResourceHasOriginalVersionInverseIterator.getHasOriginalVersionInverse());
		} catch (Exception e) {
