...
public class ContinuingResourceHasInstanceType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ContinuingResourceHasInstanceType currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinuingResourceHasInstanceType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinuingResourceHasInstanceIterator.getType());
		} catch (Exception e) {
