...
public class TitleHasPart extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TitleHasPart currentInstance = null;
	private static final Log log = LogFactory.getLog(TitleHasPart.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTitleHasPartIterator.getHasPart());
		} catch (Exception e) {
