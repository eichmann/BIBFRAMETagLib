...
public class TitleDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TitleDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TitleDateIterator.class);
