...
public class TitleNameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static TitleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TitleNameIterator.class);
