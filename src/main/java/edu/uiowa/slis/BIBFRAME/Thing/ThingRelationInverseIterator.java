...
public class ThingRelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingRelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingRelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingRelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingRelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingRelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingRelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingRelation doEndTag", e);
			throw new JspTagException("Exception raised in ThingRelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingRelationIterator");
