...
public class ThingAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingAccompaniesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingAccompaniesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in ThingAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingAccompaniesIterator");
