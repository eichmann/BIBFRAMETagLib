...
public class ThingBirthDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingBirthDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingBirthDateIterator.class);
