...
public class ThingAgentInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingAgentInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingAgentInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThingAgentInverseIterator.getAgentInverse());
		} catch (Exception e) {
