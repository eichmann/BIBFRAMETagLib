...
public class ThingPrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingPrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingPrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingPrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingPrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingPrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingPrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingPrecedes doEndTag", e);
			throw new JspTagException("Exception raised in ThingPrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingPrecedesIterator");
