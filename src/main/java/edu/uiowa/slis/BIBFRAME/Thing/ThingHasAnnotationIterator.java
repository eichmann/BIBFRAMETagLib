...
public class ThingHasAnnotationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingHasAnnotationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasAnnotationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingHasAnnotationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasAnnotationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingHasAnnotationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasAnnotationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingHasAnnotation doEndTag", e);
			throw new JspTagException("Exception raised in ThingHasAnnotation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingHasAnnotationIterator");
