...
public class ThingNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNoteIterator.class);
