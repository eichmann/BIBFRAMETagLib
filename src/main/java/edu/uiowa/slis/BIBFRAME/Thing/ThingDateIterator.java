...
public class ThingDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingDateIterator.class);
