...
public class ThingAgentInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingAgentInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingAgentInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingAgentInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingAgentInverseIterator doStartTag");
		}
