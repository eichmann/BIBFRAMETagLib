...
public class ThingAtLocationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingAtLocationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingAtLocationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingAtLocationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingAtLocationIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingAtLocationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingAtLocationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingAtLocation doEndTag", e);
			throw new JspTagException("Exception raised in ThingAtLocation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingAtLocationIterator");
