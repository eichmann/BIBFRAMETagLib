...
public class ThingLanguageIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingLanguageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingLanguageIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingLanguageIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingLanguageIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingLanguageIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingLanguageIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingLanguage doEndTag", e);
			throw new JspTagException("Exception raised in ThingLanguage doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingLanguageIterator");
