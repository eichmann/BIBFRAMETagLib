...
public class ThingDeathDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingDeathDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingDeathDateIterator.class);
