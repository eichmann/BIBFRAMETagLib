...
public class ThingFollowsIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingFollowsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingFollowsIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingFollowsIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingFollowsIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingFollowsIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingFollowsIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingFollows doEndTag", e);
			throw new JspTagException("Exception raised in ThingFollows doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingFollowsIterator");
