...
public class ThingIdentifiedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static ThingIdentifiedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingIdentifiedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingIdentifiedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingIdentifiedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingIdentifiedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingIdentifiedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingIdentifiedBy doEndTag", e);
			throw new JspTagException("Exception raised in ThingIdentifiedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingIdentifiedByIterator");
