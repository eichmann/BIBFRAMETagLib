...
public class IntegratingResourceTranslatesType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceTranslatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceTranslatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourceTranslatesIterator.getType());
		} catch (Exception e) {
