...
public class IntegratingResourceLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceLanguageNoteIterator.class);
