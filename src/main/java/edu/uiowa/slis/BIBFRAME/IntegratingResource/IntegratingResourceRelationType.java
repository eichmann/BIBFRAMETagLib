...
public class IntegratingResourceRelationType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceRelationType currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceRelationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourceRelationIterator.getType());
		} catch (Exception e) {
