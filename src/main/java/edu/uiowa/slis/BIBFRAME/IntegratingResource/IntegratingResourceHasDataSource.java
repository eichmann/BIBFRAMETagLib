...
public class IntegratingResourceHasDataSource extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceHasDataSource currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceHasDataSource.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourceHasDataSourceIterator.getHasDataSource());
		} catch (Exception e) {
