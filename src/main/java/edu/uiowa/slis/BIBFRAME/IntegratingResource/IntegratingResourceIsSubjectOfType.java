...
public class IntegratingResourceIsSubjectOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceIsSubjectOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceIsSubjectOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourceIsSubjectOfIterator.getType());
		} catch (Exception e) {
