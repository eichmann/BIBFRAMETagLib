...
public class IntegratingResourceTranslatedAs extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceTranslatedAs currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceTranslatedAs.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourceTranslatedAsIterator.getTranslatedAs());
		} catch (Exception e) {
