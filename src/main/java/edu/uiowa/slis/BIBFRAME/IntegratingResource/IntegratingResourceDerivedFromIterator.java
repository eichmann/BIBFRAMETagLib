...
public class IntegratingResourceDerivedFromIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceDerivedFromIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceDerivedFromIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceDerivedFromIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceDerivedFromIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceDerivedFromIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceDerivedFromIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IntegratingResourceDerivedFrom doEndTag", e);
			throw new JspTagException("Exception raised in IntegratingResourceDerivedFrom doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IntegratingResourceDerivedFromIterator");
