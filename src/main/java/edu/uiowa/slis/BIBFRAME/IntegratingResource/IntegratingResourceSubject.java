...
public class IntegratingResourceSubject extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceSubject currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceSubject.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourceSubjectIterator.getSubject());
		} catch (Exception e) {
