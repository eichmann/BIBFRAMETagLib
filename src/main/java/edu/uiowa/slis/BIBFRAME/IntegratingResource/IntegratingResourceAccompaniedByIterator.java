...
public class IntegratingResourceAccompaniedByIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceAccompaniedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceAccompaniedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceAccompaniedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceAccompaniedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceAccompaniedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceAccompaniedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IntegratingResourceAccompaniedBy doEndTag", e);
			throw new JspTagException("Exception raised in IntegratingResourceAccompaniedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IntegratingResourceAccompaniedByIterator");
