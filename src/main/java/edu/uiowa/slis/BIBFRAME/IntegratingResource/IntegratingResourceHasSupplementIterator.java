...
public class IntegratingResourceHasSupplementIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceHasSupplementIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceHasSupplementIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceHasSupplementIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceHasSupplementIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceHasSupplementIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceHasSupplementIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IntegratingResourceHasSupplement doEndTag", e);
			throw new JspTagException("Exception raised in IntegratingResourceHasSupplement doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setHasSupplement(String theHasSupplement) {
		hasSupplement = theHasSupplement;
	}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IntegratingResourceHasSupplementIterator");
