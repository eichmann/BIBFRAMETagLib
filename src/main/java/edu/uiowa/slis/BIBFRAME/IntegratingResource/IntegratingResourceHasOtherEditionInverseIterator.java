...
public class IntegratingResourceHasOtherEditionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceHasOtherEditionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceHasOtherEditionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IntegratingResourceHasOtherEditionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceHasOtherEditionInverseIterator doStartTag");
		}
