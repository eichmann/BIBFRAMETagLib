...
public class IntegratingResourcePrecedesInNarrativeIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourcePrecedesInNarrativeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourcePrecedesInNarrativeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IntegratingResourcePrecedesInNarrativeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourcePrecedesInNarrativeIterator doStartTag");
		}
