...
public class IntegratingResourceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://bib.ld4l.org/ontology/IntegratingResource> . "+
