...
public class IntegratingResourcePrecedesInNarrative extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourcePrecedesInNarrative currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourcePrecedesInNarrative.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourcePrecedesInNarrativeIterator.getPrecedesInNarrative());
		} catch (Exception e) {
