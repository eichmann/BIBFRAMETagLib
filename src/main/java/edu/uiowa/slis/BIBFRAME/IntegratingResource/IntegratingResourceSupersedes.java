...
public class IntegratingResourceSupersedes extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceSupersedes currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceSupersedes.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourceSupersedesIterator.getSupersedes());
		} catch (Exception e) {
