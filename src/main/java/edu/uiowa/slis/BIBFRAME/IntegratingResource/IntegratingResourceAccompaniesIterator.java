...
public class IntegratingResourceAccompaniesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceAccompaniesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceAccompaniesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceAccompaniesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceAccompaniesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceAccompaniesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceAccompaniesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IntegratingResourceAccompanies doEndTag", e);
			throw new JspTagException("Exception raised in IntegratingResourceAccompanies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IntegratingResourceAccompaniesIterator");
