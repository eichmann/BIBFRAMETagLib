...
public class IntegratingResourceHasPartType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceHasPartType currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceHasPartType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIntegratingResourceHasPartIterator.getType());
		} catch (Exception e) {
