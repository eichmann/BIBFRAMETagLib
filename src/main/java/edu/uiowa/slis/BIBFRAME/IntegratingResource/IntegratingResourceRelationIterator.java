...
public class IntegratingResourceRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceRelationIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceRelationIterator doStartTag");
		}
