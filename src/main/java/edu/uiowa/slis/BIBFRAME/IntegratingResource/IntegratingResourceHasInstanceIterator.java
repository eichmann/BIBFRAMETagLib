...
public class IntegratingResourceHasInstanceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IntegratingResourceHasInstanceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IntegratingResourceHasInstanceIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceHasInstanceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceHasInstanceIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IntegratingResourceHasInstanceIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IntegratingResourceHasInstanceIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IntegratingResourceHasInstance doEndTag", e);
			throw new JspTagException("Exception raised in IntegratingResourceHasInstance doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IntegratingResourceHasInstanceIterator");
