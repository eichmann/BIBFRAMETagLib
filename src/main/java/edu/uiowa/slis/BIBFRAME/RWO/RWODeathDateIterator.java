...
public class RWODeathDateIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static RWODeathDateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RWODeathDateIterator.class);
