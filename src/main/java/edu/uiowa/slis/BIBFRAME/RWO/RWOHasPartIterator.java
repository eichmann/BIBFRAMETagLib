...
public class RWOHasPartIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static RWOHasPartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RWOHasPartIterator.class);
...
//					continue;
			...
			log.error("Exception raised in RWOHasPartIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RWOHasPartIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in RWOHasPartIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RWOHasPartIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in RWOHasPart doEndTag", e);
			throw new JspTagException("Exception raised in RWOHasPart doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to RWOHasPartIterator");
