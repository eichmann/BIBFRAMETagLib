...
public class RWONameIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static RWONameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RWONameIterator.class);
