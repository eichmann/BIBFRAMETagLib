...
public class RWOPrecedesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static RWOPrecedesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RWOPrecedesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in RWOPrecedesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RWOPrecedesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in RWOPrecedesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RWOPrecedesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in RWOPrecedes doEndTag", e);
			throw new JspTagException("Exception raised in RWOPrecedes doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to RWOPrecedesIterator");
