...
public class RWORelationInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static RWORelationInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RWORelationInverseIterator.class);
...
//					continue;
			...
			log.error("Exception raised in RWORelationInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RWORelationInverseIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in RWORelationIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RWORelationIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in RWORelation doEndTag", e);
			throw new JspTagException("Exception raised in RWORelation doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to RWORelationIterator");
