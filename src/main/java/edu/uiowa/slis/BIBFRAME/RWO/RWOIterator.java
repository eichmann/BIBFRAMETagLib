...
public class RWOIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static RWOIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RWOIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.loc.gov/mads/rdf/v1#RWO> . "+
