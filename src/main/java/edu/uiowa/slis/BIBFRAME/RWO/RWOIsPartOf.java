...
public class RWOIsPartOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static RWOIsPartOf currentInstance = null;
	private static final Log log = LogFactory.getLog(RWOIsPartOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theRWOIsPartOfIterator.getIsPartOf());
		} catch (Exception e) {
