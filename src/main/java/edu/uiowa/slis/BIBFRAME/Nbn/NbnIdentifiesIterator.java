...
public class NbnIdentifiesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static NbnIdentifiesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NbnIdentifiesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (theNbn != null) {
				subjectURI = theNbn.getSubjectURI();
			}

			if (theNbn == null && subjectURI == null) {
...
//					continue;
			...
			log.error("Exception raised in NbnIdentifiesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NbnIdentifiesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in NbnIdentifiesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NbnIdentifiesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NbnIdentifies doEndTag", e);
			throw new JspTagException("Exception raised in NbnIdentifies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to NbnIdentifiesIterator");
