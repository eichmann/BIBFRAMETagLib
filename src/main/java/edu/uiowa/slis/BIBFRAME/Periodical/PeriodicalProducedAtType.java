...
public class PeriodicalProducedAtType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalProducedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalProducedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalProducedAtIterator.getType());
		} catch (Exception e) {
