...
public class PeriodicalRelationInverseType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalRelationInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalRelationInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalRelationInverseIterator.getType());
		} catch (Exception e) {
