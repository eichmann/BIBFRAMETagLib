...
public class PeriodicalHasOriginalVersion extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalHasOriginalVersion currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasOriginalVersion.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalHasOriginalVersionIterator.getHasOriginalVersion());
		} catch (Exception e) {
