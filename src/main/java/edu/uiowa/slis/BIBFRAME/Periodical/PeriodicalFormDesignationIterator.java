...
public class PeriodicalFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalFormDesignationIterator.class);
