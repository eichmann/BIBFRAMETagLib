...
public class PeriodicalHasOtherEditionInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalHasOtherEditionInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasOtherEditionInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PeriodicalHasOtherEditionInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalHasOtherEditionInverseIterator doStartTag");
		}
