...
public class PeriodicalIsSubjectOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalIsSubjectOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalIsSubjectOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalIsSubjectOfIterator.getType());
		} catch (Exception e) {
