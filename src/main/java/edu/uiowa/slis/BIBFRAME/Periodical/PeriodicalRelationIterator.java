...
public class PeriodicalRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalRelationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PeriodicalRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalRelationIterator doStartTag");
		}
