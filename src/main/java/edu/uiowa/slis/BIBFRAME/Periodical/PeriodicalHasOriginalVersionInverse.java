...
public class PeriodicalHasOriginalVersionInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalHasOriginalVersionInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasOriginalVersionInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalHasOriginalVersionInverseIterator.getHasOriginalVersionInverse());
		} catch (Exception e) {
