...
public class PeriodicalRelation extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalRelation currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalRelation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalRelationIterator.getRelation());
		} catch (Exception e) {
