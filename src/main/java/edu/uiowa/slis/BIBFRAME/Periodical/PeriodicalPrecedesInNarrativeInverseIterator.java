...
public class PeriodicalPrecedesInNarrativeInverseIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPrecedesInNarrativeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPrecedesInNarrativeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PeriodicalPrecedesInNarrativeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalPrecedesInNarrativeInverseIterator doStartTag");
		}
