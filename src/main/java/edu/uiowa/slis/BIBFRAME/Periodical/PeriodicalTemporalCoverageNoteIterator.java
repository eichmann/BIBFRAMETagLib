...
public class PeriodicalTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalTemporalCoverageNoteIterator.class);
