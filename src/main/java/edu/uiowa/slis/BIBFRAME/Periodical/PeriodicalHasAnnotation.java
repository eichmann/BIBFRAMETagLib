...
public class PeriodicalHasAnnotation extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalHasAnnotation currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasAnnotation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalHasAnnotationIterator.getHasAnnotation());
		} catch (Exception e) {
