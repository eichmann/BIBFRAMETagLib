...
public class PeriodicalIsLastOf extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalIsLastOf currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalIsLastOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalIsLastOfIterator.getIsLastOf());
		} catch (Exception e) {
