...
public class PeriodicalSupersededBy extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalSupersededBy currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalSupersededBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalSupersededByIterator.getSupersededBy());
		} catch (Exception e) {
