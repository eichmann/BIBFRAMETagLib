...
public class PeriodicalSplitIntoType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalSplitIntoType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalSplitIntoType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalSplitIntoIterator.getType());
		} catch (Exception e) {
