...
public class PeriodicalAgentInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalAgentInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalAgentInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalAgentInverseIterator.getAgentInverse());
		} catch (Exception e) {
