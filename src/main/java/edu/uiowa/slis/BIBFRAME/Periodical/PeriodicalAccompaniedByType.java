...
public class PeriodicalAccompaniedByType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalAccompaniedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalAccompaniedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalAccompaniedByIterator.getType());
		} catch (Exception e) {
