...
public class PeriodicalHasDataSourceType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalHasDataSourceType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasDataSourceType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalHasDataSourceIterator.getType());
		} catch (Exception e) {
