...
public class PeriodicalHasDataSourceIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalHasDataSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasDataSourceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PeriodicalHasDataSourceIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalHasDataSourceIterator doStartTag");
		}
