...
public class PeriodicalPrecedesInNarrativeType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static PeriodicalPrecedesInNarrativeType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPrecedesInNarrativeType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalPrecedesInNarrativeIterator.getType());
		} catch (Exception e) {
