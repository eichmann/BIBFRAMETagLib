...
public class MultipartMonographLanguageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultipartMonographLanguageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultipartMonographLanguageNoteIterator.class);
