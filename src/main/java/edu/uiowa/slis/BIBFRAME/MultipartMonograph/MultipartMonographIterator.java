...
public class MultipartMonographIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultipartMonographIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultipartMonographIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://bib.ld4l.org/ontology/MultipartMonograph> . "+
