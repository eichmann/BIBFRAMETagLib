...
public class MultipartMonographFormDesignationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultipartMonographFormDesignationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultipartMonographFormDesignationIterator.class);
