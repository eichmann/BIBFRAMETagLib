...
public class MultipartMonographIsSubjectOfType extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultipartMonographIsSubjectOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(MultipartMonographIsSubjectOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultipartMonographIsSubjectOfIterator.getType());
		} catch (Exception e) {
