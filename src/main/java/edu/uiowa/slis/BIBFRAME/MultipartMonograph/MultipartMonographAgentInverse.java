...
public class MultipartMonographAgentInverse extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultipartMonographAgentInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(MultipartMonographAgentInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultipartMonographAgentInverseIterator.getAgentInverse());
		} catch (Exception e) {
