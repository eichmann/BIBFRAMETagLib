...
public class MultipartMonographTemporalCoverageNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static MultipartMonographTemporalCoverageNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultipartMonographTemporalCoverageNoteIterator.class);
