...
public class UdcShelfMarkSemanticRelationIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static UdcShelfMarkSemanticRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UdcShelfMarkSemanticRelationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in UdcShelfMarkSemanticRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in UdcShelfMarkSemanticRelationIterator doStartTag");
		}
