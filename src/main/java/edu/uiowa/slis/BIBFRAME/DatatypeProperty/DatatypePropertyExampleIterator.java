...
public class DatatypePropertyExampleIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static DatatypePropertyExampleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyExampleIterator.class);
