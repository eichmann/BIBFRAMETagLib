...
public class FunctionalPropertyNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FunctionalPropertyNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FunctionalPropertyNoteIterator.class);
