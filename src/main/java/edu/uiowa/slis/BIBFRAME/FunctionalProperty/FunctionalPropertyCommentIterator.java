...
public class FunctionalPropertyCommentIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static FunctionalPropertyCommentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FunctionalPropertyCommentIterator.class);
