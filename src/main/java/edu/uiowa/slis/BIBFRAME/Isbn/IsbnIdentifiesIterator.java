...
public class IsbnIdentifiesIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static IsbnIdentifiesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IsbnIdentifiesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (theIsbn != null) {
				subjectURI = theIsbn.getSubjectURI();
			}

			if (theIsbn == null && subjectURI == null) {
...
//					continue;
			...
			log.error("Exception raised in IsbnIdentifiesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IsbnIdentifiesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IsbnIdentifiesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IsbnIdentifiesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IsbnIdentifies doEndTag", e);
			throw new JspTagException("Exception raised in IsbnIdentifies doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IsbnIdentifiesIterator");
