...
public class SymmetricPropertyEditorialNoteIterator extends edu.uiowa.slis.BIBFRAME.TagLibSupport {
	static SymmetricPropertyEditorialNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SymmetricPropertyEditorialNoteIterator.class);
